...
if(IS_64BIT)
    ...
    if(CMAKE_BUILD_TYPE STREQUAL "Debug")
        set(MYSQL_LIBRARIES ${CMAKE_SOURCE_DIR}/dep/lib/libmysql_debug_x32.lib CACHE INTERNAL "OpenSSL libraries." FORCE)
    else()
        set(MYSQL_LIBRARIES ${CMAKE_SOURCE_DIR}/dep/lib/libmysql_release_x32.lib  CACHE INTERNAL "OpenSSL libraries." FORCE)
    endif()
endif()
