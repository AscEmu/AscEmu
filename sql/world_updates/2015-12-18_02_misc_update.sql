...
-- Dark Iron Kidnapper
INSERT INTO `creature_spawns` VALUES (199006, 15692, 0, -6600.01, -1848.25, 244.266, 2.61101, 2, 7792, 54, 32768, 16777475, 0, 4097, 0, 0, 0, 0, 0, 0, 0, 0, 15215, 0, 0, 0, 1);
INSERT INTO `creature_waypoints` VALUES (199006, 1, -6600.01, -1848.25, 244.266, 10000, 0, 1, 0, 1, 0, 7792, 7792);
INSERT INTO `creature_waypoints` VALUES (199006, 2, -6616.01, -1850.34, 244.152, 10000, 0, 1, 0, 1, 0, 7792, 7792);
INSERT INTO `creature_waypoints` VALUES (199006, 3, -6614.67, -1864.57, 244.207, 10000, 0, 1, 0, 1, 0, 7792, 7792);
INSERT INTO `creature_waypoints` VALUES (199006, 4, -6602.01, -1863.24, 244.694, 10000, 0, 1, 0, 1, 0, 7792, 7792);
...
INSERT INTO `creature_waypoints` VALUES (41118, 1, -6604.43, -1864.63, 244.62, 10000, 0, 1, 0, 1, 0, 7793, 7793);
INSERT INTO `creature_waypoints` VALUES (41118, 2, -6611.68, -1870.47, 244.35, 10000, 0, 1, 0, 1, 0, 7793, 7793);
INSERT INTO `creature_waypoints` VALUES (41118, 3, -6599.88, -1878.65, 244.91, 10000, 0, 1, 0, 1, 0, 7793, 7793);
INSERT INTO `creature_waypoints` VALUES (41118, 4, -6594.51, -1870.84, 245.16, 10000, 0, 1, 0, 1, 0, 7793, 7793);
...
-- NPC deleted non-event.
DELETE FROM `event_creature_spawns` WHERE `id`=156767;
DELETE FROM `event_creature_spawns` WHERE `id`=156770;
DELETE FROM `event_creature_spawns` WHERE `id`=156766;
DELETE FROM `event_creature_spawns` WHERE `id`=156768;
DELETE FROM `event_creature_spawns` WHERE `id`=156769;
DELETE FROM `event_creature_spawns` WHERE `id`=156764;
