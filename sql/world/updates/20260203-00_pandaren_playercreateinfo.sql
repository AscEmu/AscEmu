...
(24, 7, @map_id, @zone_id, @pos_x, @pos_y, @pos_z, @pos_o, @mop_build),
...
(25, 7, @map_id, @zone_id, @pos_x, @pos_y, @pos_z, @pos_o, @mop_build),
...
(26, 7, @map_id, @zone_id, @pos_x, @pos_y, @pos_z, @pos_o, @mop_build),
...
(24, 7, 49, 3, 1, @mop_build),
(24, 7, 48, 6, 1, @mop_build),
