...
DELETE FROM `creature_spawns` WHERE `id`=290103;
...
DELETE FROM `creature_spawns` WHERE `id`=316446;

DELETE FROM `creature_spawns` WHERE `id`=290102;
DELETE FROM `creature_spawns` WHERE `id`=285746;
DELETE FROM `creature_spawns` WHERE `id`=288326;
...
INSERT INTO `world_db_version` (`id`, `LastUpdate`) VALUES ('156', '20251109-00_creature_spawns');
