...
- Include clear steps to reproduce the issue (for bugs).
- Describe how the feature or behavior should work on retail.
- Screenshots and logs can be a huge help! 📸
...
- Improving documentation, testing, or developer experience
