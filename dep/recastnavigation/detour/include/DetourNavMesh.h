...
private:
    ...
    ///\todo These methods are duplicates from dtNavMeshQuery, but are needed for off-mesh connection finding.
	...
	dtNavMeshParams m_params;			// Current initialization params. \todo do not store this info twice.
