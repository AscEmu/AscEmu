...
public:
    void OnQuestStart(Player* mTarget, QuestLogEntry* /*qLogEntry*/) override
    {
        if (BaronVardusAllowSpawn == true)
        {
            ...
            {
                case 0:
                    mTarget->getWorldMap()->getInterface()->SpawnCreature(2306, 692.64f, -904.74f, 157.79f, 0, true, false, 0, 0)->Despawn(1800000, 0);
                    break;
                case 1:
                    mTarget->getWorldMap()->getInterface()->SpawnCreature(2306, 939.0f, -852.46f, 114.644f, 0, true, false, 0, 0)->Despawn(1800000, 0);
                    break;
                case 2:
                    mTarget->getWorldMap()->getInterface()->SpawnCreature(2306, 1184.07f, -553.43f, 71.3346f, 0, true, false, 0, 0)->Despawn(1800000, 0);
                    break;
                case 3:
                    mTarget->getWorldMap()->getInterface()->SpawnCreature(2306, 1001.20f, -793.93f, 108.65f, 0, true, false, 0, 0)->Despawn(1800000, 0);
                    break;
            }
