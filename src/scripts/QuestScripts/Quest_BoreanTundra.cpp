...
public:
    ...
    void OnActivate(Player* pPlayer) override
    {
        ...
        Creature* Twonky = pPlayer->getWorldMap()->createAndSpawnCreature(25830, 4117.513672f, 5089.670898f, -1.506265f, 2.043593f);
        if (Twonky->isAlive())
            _gameobject->setState(GO_STATE_OPEN);
        else
            _gameobject->setState(GO_STATE_CLOSED);
...
public:
    ...
    void OnActivate(Player* pPlayer) override
    {
        ...
        Creature* Ed210 = pPlayer->getWorldMap()->createAndSpawnCreature(25831, 4218.529785f, 4802.284668f, -12.975346f, 5.833142f);
        if (Ed210->isAlive())
            _gameobject->setState(GO_STATE_OPEN);
        else
            _gameobject->setState(GO_STATE_CLOSED);
...
public:
    ...
    void OnActivate(Player* pPlayer) override
    {
        ...
        Creature* MaxBlasto = pPlayer->getWorldMap()->createAndSpawnCreature(25832, 4029.974609f, 4890.195313f, -12.775084f, 1.081481f);
...
public:
    ...
    void OnActivate(Player* pPlayer) override
    {
        ...
        Creature* TheGrinder = pPlayer->getWorldMap()->createAndSpawnCreature(25833, 3787.021484f, 4821.941895f, -12.967110f, 5.097224f);
...
public:
    ...
    void OnActivate(Player* pPlayer) override
    {
        ...
        Creature* GearmasterMechazod = pPlayer->getWorldMap()->createAndSpawnCreature(25834, 4006.289551f, 4848.437500f, 25.957747f, 2.459837f);
