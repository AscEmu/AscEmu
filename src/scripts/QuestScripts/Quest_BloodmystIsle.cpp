    ...
    public:
        ...
        void OnDied(Unit* pKiller)
        {
            ...
            if(Quest == NULL)
            {
                ...
                RandomCreature = _unit->GetMapMgr()->GetInterface()->SpawnCreature(Id[ rand() % 50 + 1 ], _unit->GetPositionX(), _unit->GetPositionY(), _unit->GetPositionZ(), _unit->GetOrientation(), true, false, 0, 0);
            ...
            else
            {
                ...
                RandomCreature = _unit->GetMapMgr()->GetInterface()->SpawnCreature(Id[ rand() % 8 +1 ], _unit->GetPositionX(), _unit->GetPositionY(), _unit->GetPositionZ(), _unit->GetOrientation(), true, false, 0, 0);
                if(RandomCreature != NULL)
                {
                    RandomCreature->m_noRespawn = true;
                    RandomCreature->Despawn(60000, 0);
