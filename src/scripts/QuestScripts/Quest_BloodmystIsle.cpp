...
public:
    ...
    void OnDied(Unit* mKiller) override
    {
        ...
        if (mKiller->isPlayer())
        {
            ...
            {
                getCreature()->getWorldMap()->getInterface()->SpawnCreature(17702, -2419, -12166, 33, 3.45f, true, false, 0, 0)->Despawn(18000000, 0);
                fulborgskilled = 0;
...
public:
    ...
    void OnDied(Unit* pKiller) override
    {
        ...
        if (!QuestHolder->hasQuestInQuestLog(9670))
        {
            ...
            Creature* RandomCreature = getCreature()->getWorldMap()->getInterface()->SpawnCreature(Id[Util::getRandomUInt(50)], pos.x, pos.y, pos.z, pos.o, true, false, 0, 0);
        ...
        else
        {
            ...
            Creature* RandomCreature = getCreature()->getWorldMap()->getInterface()->SpawnCreature(Id[Util::getRandomUInt(7)], pos.x, pos.y, pos.z, pos.o, true, false, 0, 0);
            if (RandomCreature != nullptr)
            {
                RandomCreature->m_noRespawn = true;
                RandomCreature->Despawn(60000, 0);
