...
public:
    ...
    void OnDied(Unit* mKiller) override
    {
        ...
        if (mKiller->isPlayer())
        {
            ...
            {
                getCreature()->getWorldMap()->getInterface()->spawnCreature(17702, LocationVector(-2419, -12166, 33, 3.45f))->Despawn(18000000, 0);
                fulborgskilled = 0;
...
public:
    ...
    void OnDied(Unit* pKiller) override
    {
        ...
        if (!QuestHolder->hasQuestInQuestLog(9670))
        {
            ...
            Creature* RandomCreature = getCreature()->getWorldMap()->getInterface()->spawnCreature(Id[Util::getRandomUInt(50)], pos);
        ...
        else
        {
            ...
            Creature* RandomCreature = getCreature()->getWorldMap()->getInterface()->spawnCreature(Id[Util::getRandomUInt(7)], pos);
            if (RandomCreature != nullptr)
            {
                RandomCreature->m_noRespawn = true;
                RandomCreature->Despawn(60000, 0);
