    ...
    public:
        ...
        void OnQuestStart(Player* mTarget, QuestLogEntry* qLogEntry)
        {
            ...
            if (mTarget->CalcDistance(Coo, mTarget) <= 10)
                sEventMgr.AddEvent(static_cast<Unit*>(Coo), &Unit::EventCastSpell, Plr, sSpellCustomizations.GetServersideSpell(30424), EVENT_CREATURE_UPDATE, 8750, 0, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
            ...
            sEventMgr.AddEvent(static_cast<Unit*>(Coo), &Unit::EventCastSpell, Totem, sSpellCustomizations.GetServersideSpell(30473), EVENT_CREATURE_UPDATE, 12750, 0, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
            Coo->Despawn(15200, 0);
        }
    ...
    public:
        ...
        void OnQuestStart(Player* mTarget, QuestLogEntry* qLogEntry)
        {
            ...
            if (mTarget->CalcDistance(Tikti, mTarget) <= 10)
                sEventMgr.AddEvent(static_cast<Unit*>(Tikti), &Unit::EventCastSpell, Plr, sSpellCustomizations.GetServersideSpell(30430), EVENT_CREATURE_UPDATE, 18000, 0, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
            ...
            sEventMgr.AddEvent(static_cast<Unit*>(Tikti), &Unit::EventCastSpell, Totem, sSpellCustomizations.GetServersideSpell(30431), EVENT_GMSCRIPT_EVENT, 20000, 0, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
...
class TotemofVark : public QuestScript
{
    public:
        ...
        void OnQuestStart(Player* mTarget, QuestLogEntry* qLogEntry)
        {
            ...
            sEventMgr.AddEvent(Totem, &Unit::EventCastSpell, Totem, sSpellCustomizations.GetServersideSpell(30446), EVENT_CREATURE_UPDATE, 15500, 0, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
            ...
            sEventMgr.AddEvent(Totem, &Unit::EventCastSpell, Totem, sSpellCustomizations.GetServersideSpell(30448), EVENT_CREATURE_UPDATE, 30000, 0, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
            ...
            if (mTarget->CalcDistance(Totem, Plr) <= 10)
                sEventMgr.AddEvent(Totem, &Unit::EventCastSpell, Plr, sSpellCustomizations.GetServersideSpell(30448), EVENT_CREATURE_UPDATE, 31000, 0, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
        }
