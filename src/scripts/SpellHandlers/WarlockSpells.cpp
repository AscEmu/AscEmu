...
bool MasterDemonologist1(uint32 i, Spell* s)
{
    ...
    {
        //for self
        Spell* sp = sSpellFactoryMgr.NewSpell(s->p_caster, sSpellCustomizations.GetServersideSpell(casted_spell_id), true, NULL);
        SpellCastTargets tgt(s->p_caster->GetGUID());
        sp->prepare(&tgt);

        //for pet
        sp = sSpellFactoryMgr.NewSpell(unitTarget, sSpellCustomizations.GetServersideSpell(casted_spell_id), true, NULL);
    ...
    {
        //for self
        Spell* sp = sSpellFactoryMgr.NewSpell(s->p_caster, sSpellCustomizations.GetServersideSpell(inc_resist_by_level_spell), true, NULL);
        SpellCastTargets tgt(s->p_caster->GetGUID());
        sp->prepare(&tgt);
        //for pet
        sp = sSpellFactoryMgr.NewSpell(unitTarget, sSpellCustomizations.GetServersideSpell(inc_resist_by_level_spell), true, NULL);
        SpellCastTargets tgt1(unitTarget->GetGUID());
        sp->prepare(&tgt1);
    }
...
bool MasterDemonologist2(uint32 i, Spell* s)
{
    ...
    {
        //for self
        Spell* sp = sSpellFactoryMgr.NewSpell(p_caster, sSpellCustomizations.GetServersideSpell(casted_spell_id), true, NULL);
    ...
    {
        //for self
        Spell* sp = sSpellFactoryMgr.NewSpell(p_caster, sSpellCustomizations.GetServersideSpell(inc_resist_by_level_spell), true, NULL);
        SpellCastTargets tgt(p_caster->GetGUID());
        sp->prepare(&tgt);
...
bool DemonicCircleSummon(uint32 i, Aura* a, bool apply)
{
    ...
    if(apply)
    {
        ...
        OLD_SpellEntry* sp = sSpellCustomizations.GetServersideSpell(48020);
