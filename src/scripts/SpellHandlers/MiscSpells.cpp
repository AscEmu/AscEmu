...
bool Give5kGold(uint32 i, Spell* s)
{
    ...
    {
        if (worldConfig.gold.isCapEnabled && (s->GetPlayerTarget()->GetGold() + 50000000) > worldConfig.gold.limitAmount)
        {
            s->GetPlayerTarget()->SetGold(worldConfig.gold.limitAmount);
