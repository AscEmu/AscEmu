...
Arcemu::Gossip::Script* CreateLuaUnitGossipScript(uint32_t id)
{
...
Arcemu::Gossip::Script* CreateLuaItemGossipScript(uint32_t id)
{
    LuaGossip* pLua = nullptr;
...
Arcemu::Gossip::Script* CreateLuaGOGossipScript(uint32_t id)
{
    LuaGossip* pLua = nullptr;
