...
class LuaGameObject
{
    public:
        ...
        static int CastSpell(lua_State* L, GameObject* ptr)
        {
            ...
            if (sp)
            {
                Spell* tSpell = sSpellFactoryMgr.NewSpell(ptr, sSpellCustomizations.GetServersideSpell(sp), true, NULL);
        ...
        static int FullCastSpellOnTarget(lua_State* L, GameObject* ptr)
        {
            ...
            if (sp && target != NULL)
            {
                Spell* tSpell = sSpellFactoryMgr.NewSpell(ptr, sSpellCustomizations.GetServersideSpell(sp), false, NULL);
