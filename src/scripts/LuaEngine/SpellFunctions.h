...
LuaSpellEntry luaSpellVars[] =
{
    ...
    /*{ "AttributesExH", 0, offsetof(SpellInfo, AttributesExH) },
    { "AttributesExI", 0, offsetof(SpellInfo, AttributesExI) },
    { "AttributesExJ", 0, offsetof(SpellInfo, AttributesExJ) },*/
    ...
    //{"EffectBaseDice", 0, offsetof(SpellInfo, EffectBaseDice[0])},
    //{"EffectDicePerLevel", 3, offsetof(SpellInfo, EffectDicePerLevel[0])},
    ...
    { "EffectSpellClassMask", 0, offsetof(SpellInfo, EffectSpellClassMask[0]) },
