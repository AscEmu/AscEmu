...
class CoilfangEngineerAI : public CreatureAIScript
{
    public:
        ...
        CoilfangEngineerAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(BOMB);
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(NET);
...
class CoilfangOracleAI : public CreatureAIScript
{
    public:
        ...
        CoilfangOracleAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(FROST_SHOCK);
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(SONIC_BURST);
            ...
            spells[2].info = sSpellCustomizations.GetServersideSpell(HEAL);
...
class CoilfangWarriorAI : public CreatureAIScript
{
    public:
        ...
        CoilfangWarriorAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(MORTAL_BLOW);
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = true;
            spells[0].cooldown = 15;
            spells[0].perctrigger = 0.0f;
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(BATTLE_SHOUT);    // should affect friends not enemies :S
            spells[1].targettype = TARGET_VARIOUS;
            spells[1].instant = true;
...
class CoilfangSirenAI : public CreatureAIScript
{
    public:
        ...
        CoilfangSirenAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(AOE_FEAR);
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(LIGHTNING_BOLT);
            spells[1].targettype = TARGET_ATTACKING;
            ...
            spells[2].info = sSpellCustomizations.GetServersideSpell(ARCANE_FLARE);
...
class BogOverlordAI : public CreatureAIScript
{
    public:
        ...
        BogOverlordAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(FUNGAL_DECAY);
            ...
            spells[2].info = sSpellCustomizations.GetServersideSpell(ENRAGE_BOG_OVERLORD);
            spells[2].targettype = TARGET_SELF;
            spells[2].instant = false;
            ...
            spells[3].info = sSpellCustomizations.GetServersideSpell(DISEASE_CLOUD);
...
class CoilfangSorceressAI : public CreatureAIScript
{
    public:
        ...
        CoilfangSorceressAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(BLIZZARD);
...
class CoilfangLeperAI : public CreatureAIScript
{
    public:
        ...
        CoilfangLeperAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(SHADOW_BOLT);
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = false;
            spells[0].cooldown = 15;
            spells[0].perctrigger = 0.0f;
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(FIRE_BLAST_LEPER);
            spells[1].targettype = TARGET_ATTACKING;
            spells[1].instant = true;
            spells[1].cooldown = 25;
            spells[1].perctrigger = 0.0f;
            ...
            spells[2].info = sSpellCustomizations.GetServersideSpell(STRIKE);
            spells[2].targettype = TARGET_ATTACKING;
            spells[2].instant = true;
            ...
            spells[3].info = sSpellCustomizations.GetServersideSpell(FROST_NOVA_LEPER);
            ...
            spells[4].info = sSpellCustomizations.GetServersideSpell(CLEAVE_LEPER);
            ...
            spells[5].info = sSpellCustomizations.GetServersideSpell(HEAL_LEPER);
            ...
            spells[6].info = sSpellCustomizations.GetServersideSpell(SUNDER_ARMOR_LEPER);
            ...
            spells[7].info = sSpellCustomizations.GetServersideSpell(SHOOT);
...
class CoilfangSlavemasterAI : public CreatureAIScript
{
    public:
        ...
        CoilfangSlavemasterAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(GEYSER);
            spells[0].targettype = TARGET_VARIOUS;
            spells[0].instant = true;
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(ENRAGE_SlAVEMASTER);
            spells[1].targettype = TARGET_VARIOUS;
            spells[1].instant = true;
...
class CoilfangWaterElementalAI : public CreatureAIScript
{
    public:
        ...
        CoilfangWaterElementalAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(WATER_BOLT_WOLLEY);
            spells[0].targettype = TARGET_VARIOUS;
            spells[0].instant = false;
            spells[0].cooldown = 10;
            spells[0].perctrigger = 0.0f;
...
class CoilfangMyrmidonAI : public CreatureAIScript
{
    public:
        ...
        CoilfangMyrmidonAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(SWEEPING_STRIKES);
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(CLEAVE);
            ...
            spells[2].info = sSpellCustomizations.GetServersideSpell(EXECUTE);
            spells[2].targettype = TARGET_ATTACKING;
            spells[2].instant = true;
            spells[2].cooldown = 35;
            spells[2].perctrigger = 0.0f;
...
class TidalSurgerAI : public CreatureAIScript
{
    public:
        ...
        TidalSurgerAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(WATER_SPOUT);
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = true;
            spells[0].cooldown = 25;
            spells[0].perctrigger = 0.0f;
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(FROST_NOVA_SURGER);
            spells[1].targettype = TARGET_VARIOUS;
            spells[1].instant = true;
            spells[1].cooldown = 15;
            spells[1].perctrigger = 0.0f;
...
class SteamSurgerAI : public CreatureAIScript
{
    public:
        ...
        SteamSurgerAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(WATER_BOLT);
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = true;
            spells[0].cooldown = 15;
            spells[0].perctrigger = 0.0f;
...
class HydromancerThespiaAI : public CreatureAIScript
{
    public:
        ...
        HydromancerThespiaAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(ENVELOPING_WINDS);
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(LIGHTNING_CLOUD);
            ...
            spells[2].info = sSpellCustomizations.GetServersideSpell(LUNG_BURST);
...
class MekgineerSteamriggerAI : public CreatureAIScript
{
    public:
        ...
        MekgineerSteamriggerAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(SUPER_SHRINK_RAY);
            spells[0].targettype = TARGET_RANDOM_SINGLE;
            spells[0].instant = true;
            spells[0].cooldown = 20;
            spells[0].perctrigger = 9.0f;
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(SAW_BLADE);
            ...
            spells[2].info = sSpellCustomizations.GetServersideSpell(ELECTRIFIED_NET);
            spells[2].targettype = TARGET_RANDOM_SINGLE;
            spells[2].instant = true;
            spells[2].cooldown = 15;
...
class WarlordKalitreshAI : public CreatureAIScript
{
    public:
        ...
        WarlordKalitreshAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(IMPALE);
            spells[0].targettype = TARGET_RANDOM_SINGLE;
            spells[0].instant = true;
            spells[0].cooldown = 10;
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(HEAD_CRACK);
            ...
            spells[2].info = sSpellCustomizations.GetServersideSpell(SPELL_REFLECTION);
            spells[2].targettype = TARGET_SELF;
            spells[2].instant = true;
            spells[2].cooldown = 25;
            spells[2].perctrigger = 8.0f;
            ...
            spells[3].info = sSpellCustomizations.GetServersideSpell(WARLORDS_RAGE);
            spells[3].targettype = TARGET_SELF;
            spells[3].instant = true;
