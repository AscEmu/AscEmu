...
class EtherealDarkcasterAI : public CreatureAIScript
{
    public:
        ...
        EtherealDarkcasterAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(SHADOW_WORD_PAIN);
...
class EtherealPriestAI : public CreatureAIScript
{
    public:
        ...
        EtherealPriestAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(HEAL);
            spells[0].targettype = TARGET_SELF; // until function to target wounded friendly unit will be done
            spells[0].instant = false;
            spells[0].perctrigger = 7.0f;
            spells[0].attackstoptimer = 1000;

            spells[1].info = sSpellCustomizations.GetServersideSpell(POWER_WORD_SHIELD);
...
class EtherealTheurgistAI : public CreatureAIScript
{
    public:
        ...
        EtherealTheurgistAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(POLYMORPH);
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = false;
            spells[0].perctrigger = 7.0f;
            spells[0].attackstoptimer = 1000;

            spells[1].info = sSpellCustomizations.GetServersideSpell(BLAST_WAVE);
...
class EtherealSorcererAI : public CreatureAIScript
{
    public:
        ...
        EtherealSorcererAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(ARCANE_MISSILES);
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = true;
            spells[0].perctrigger = 10.0f;
            spells[0].attackstoptimer = 1000;
...
class NexusStalkerAI : public CreatureAIScript
{
    public:
        ...
        NexusStalkerAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(GOUGE);
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = true;
            spells[0].perctrigger = 10.0f;
            spells[0].attackstoptimer = 1000;

            spells[1].info = sSpellCustomizations.GetServersideSpell(POISON);
            spells[1].targettype = TARGET_ATTACKING;
            spells[1].instant = true;
            spells[1].perctrigger = 7.0f;
            spells[1].attackstoptimer = 1000;

            spells[2].info = sSpellCustomizations.GetServersideSpell(STEALTH);
...
class NexusTerrorAI : public CreatureAIScript
{
    public:
        ...
        NexusTerrorAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(PSYCHIC_SCREAM);
...
class ManaLeechAI : public CreatureAIScript
{
    public:
        ...
        ManaLeechAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(ARCANE_EXPLOSION);
            spells[0].targettype = TARGET_VARIOUS;
            spells[0].instant = true;
...
class EtherealSpellbinderAI : public CreatureAIScript
{
    public:
        ...
        EtherealSpellbinderAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(CORRUPTION);
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = true;
            spells[0].perctrigger = 7.0f;
            spells[0].attackstoptimer = 1000;

            spells[1].info = sSpellCustomizations.GetServersideSpell(IMMOLATE);
            spells[1].targettype = TARGET_ATTACKING;
            spells[1].instant = true;
            spells[1].perctrigger = 7.0f;
            spells[1].attackstoptimer = 1000;

            spells[2].info = sSpellCustomizations.GetServersideSpell(UNSTABLE_AFFLICTION);
            spells[2].targettype = TARGET_ATTACKING;
            spells[2].instant = true;
            spells[2].perctrigger = 7.0f;
            spells[2].attackstoptimer = 1000;

            spells[2].info = sSpellCustomizations.GetServersideSpell(SUMMON_ETHEREAL_WRAITH);
            spells[2].targettype = TARGET_SELF;  // ?
            spells[2].instant = true;
            spells[2].perctrigger = 5.0f;
            spells[2].attackstoptimer = 1000;
...
class EtherealWraithAI : public CreatureAIScript
{
    public:
        ...
        EtherealWraithAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(SHADOW_BOLT_VOLLEY);
...
class PandemoniusAI : public CreatureAIScript
{
    public:
        ...
        PandemoniusAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(DARK_SHELL);
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(VOID_BLAST);
...
class TavarokAI : public CreatureAIScript
{
    public:
        ...
        TavarokAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(CRYSTAL_PRISON);
            spells[1].targettype = TARGET_RANDOM_SINGLE;
            spells[1].instant = true;
            ...
            spells[2].info = sSpellCustomizations.GetServersideSpell(ARCING_SMASH);
...
class NexusPrinceShaffarAI : public CreatureAIScript
{
    public:
        ...
        NexusPrinceShaffarAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(FROSTBOLT);
            spells[1].targettype = TARGET_RANDOM_SINGLE;
            spells[1].instant = false;
            ...
            spells[3].info = sSpellCustomizations.GetServersideSpell(BLINK);
            ...
            spells[4].info = sSpellCustomizations.GetServersideSpell(SUMMON_ETEREAL_BECON);
...
class YorAI : public CreatureAIScript
{
    public:
        ...
        YorAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(DOUBLE_BREATH);
            spells[0].targettype = TARGET_VARIOUS;
            spells[0].instant = true;
            spells[0].perctrigger = 20.0f;
            spells[0].attackstoptimer = 2000;
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(STOMP);
            spells[1].targettype = TARGET_VARIOUS;
            spells[1].instant = true;
            spells[1].perctrigger = 7.0f;
            spells[1].attackstoptimer = 2000;
