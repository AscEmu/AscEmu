...
DeathKnightUnderstudyAI::DeathKnightUnderstudyAI(Creature* pCreature) : MoonScriptCreatureAI(pCreature)
{
    ...
    blood_strike_spell->spell = sSpellCustomizations.GetServersideSpell(DEATH_KNIGHT_UNDERSTUDY_BLOOD_STRIKE);
    ...
    blood_strike_spell->cooldown = objmgr.GetPetSpellCooldown(blood_strike_spell->spell->Id);
    ...
    _unit->GetAIInterface()->addSpellToList(blood_strike_spell);
    delete blood_strike_spell;

    // Bone Barrier
    auto bone_barrier_spell = new AI_Spell;
    bone_barrier_spell->spell = sSpellCustomizations.GetServersideSpell(DEATH_KNIGHT_UNDERSTUDY_BONE_BARRIER);
    ...
    bone_barrier_spell->cooldown = objmgr.GetPetSpellCooldown(bone_barrier_spell->spell->Id);
    ...
    _unit->GetAIInterface()->addSpellToList(bone_barrier_spell);
    delete bone_barrier_spell;

    // Taunt
    auto understudy_taunt_spell = new AI_Spell;
    understudy_taunt_spell->spell = sSpellCustomizations.GetServersideSpell(DEATH_KNIGHT_UNDERSTUDY_TAUNT);
    ...
    understudy_taunt_spell->cooldown = objmgr.GetPetSpellCooldown(understudy_taunt_spell->spell->Id);
    ...
    _unit->GetAIInterface()->addSpellToList(understudy_taunt_spell);
...
class StickedSpewerAI : public CreatureAIScript
{
    ...
    StickedSpewerAI(Creature* pCreature) : CreatureAIScript(pCreature)
    {
        ...
        spells[0].info = sSpellCustomizations.GetServersideSpell(CN_SLIME_BOLT);
        spells[0].targettype = TARGET_VARIOUS;
        spells[0].instant = false;
        spells[0].perctrigger = 10.0f;
        spells[0].attackstoptimer = 2000; // 1sec

        spells[1].info = sSpellCustomizations.GetServersideSpell(CN_UPPERCUT);
...
class SurgicalAssistantAI : public CreatureAIScript
{
    ...
    SurgicalAssistantAI(Creature* pCreature) : CreatureAIScript(pCreature)
    {
        ...
        // Create basic info for spells here, and play with it later , fill always the info, targettype and if is instant or not!
        spells[0].info = sSpellCustomizations.GetServersideSpell(MIND_FLAY);
...
class SludgeBelcherAI : public CreatureAIScript
{
    ...
    SludgeBelcherAI(Creature* pCreature) : CreatureAIScript(pCreature)
    {
        ...
        // Create basic info for spells here, and play with it later , fill always the info, targettype and if is instant or not!
        spells[0].info = sSpellCustomizations.GetServersideSpell(DISEISE_BUFFET);
        spells[0].targettype = TARGET_ATTACKING;
        spells[0].instant = false;
        spells[0].perctrigger = 20.0f;
        spells[0].attackstoptimer = 1000; // 1sec

        spells[1].info = sSpellCustomizations.GetServersideSpell(SUMMON_BILE_SLIMES);
...
class GrobbulusAI : public CreatureAIScript
{
    ...
    GrobbulusAI(Creature* pCreature) : CreatureAIScript(pCreature)
    {
        ...
        // Create basic info for spells here, and play with it later , fill always the info, targettype and if is instant or not!
        spells[0].info = sSpellCustomizations.GetServersideSpell(POISON_CLOUD_GROB);
        spells[0].targettype = TARGET_SELF;
        spells[0].instant = false;
        spells[0].perctrigger = 0.0f;
        spells[0].attackstoptimer = 1000; // 1sec

        spells[1].info = sSpellCustomizations.GetServersideSpell(SLIME_SPRAY);
        spells[1].targettype = TARGET_VARIOUS;
        spells[1].instant = false;
...
class GluthAI : public CreatureAIScript
{
    ...
    GluthAI(Creature* pCreature) : CreatureAIScript(pCreature)
    {
        ...
        // Create basic info for spells here, and play with it later , fill always the info, targettype and if is instant or not!
        spells[0].info = sSpellCustomizations.GetServersideSpell(MORTAL_WOUND);
        spells[0].targettype = TARGET_ATTACKING;
        spells[0].instant = false;
        spells[0].perctrigger = 15.0f;
        spells[0].attackstoptimer = 2000; // 1sec

        spells[1].info = sSpellCustomizations.GetServersideSpell(TERRIFYING_ROAR);
        spells[1].targettype = TARGET_VARIOUS;
        spells[1].instant = false;
        spells[1].perctrigger = 5.0f;
        spells[1].attackstoptimer = 3000; // 1sec

        spells[2].info = sSpellCustomizations.GetServersideSpell(FRENZY);
...
class BonyConstructAI : public CreatureAIScript
{
    ...
    BonyConstructAI(Creature* pCreature) : CreatureAIScript(pCreature)
    {
        ...
        // Create basic info for spells here, and play with it later , fill always the info, targettype and if is instant or not!
        spells[0].info = sSpellCustomizations.GetServersideSpell(SWEEPING_SLAM);
        spells[0].targettype = TARGET_VARIOUS;
        spells[0].instant = false;
        spells[0].perctrigger = 15.0f;
        spells[0].attackstoptimer = 2000; // 1sec
...
class DeathLordAI : public CreatureAIScript
{
    ...
    DeathLordAI(Creature* pCreature) : CreatureAIScript(pCreature)
    {
        ...
        // Create basic info for spells here, and play with it later , fill always the info, targettype and if is instant or not!
        spells[0].info = sSpellCustomizations.GetServersideSpell(AURA_OF_AGONY);
        spells[0].targettype = TARGET_VARIOUS;
        spells[0].instant = false;
        spells[0].perctrigger = 15.0f;
        spells[0].attackstoptimer = 2000; // 1sec
...
class RazuviousAI : public CreatureAIScript
{
    ...
    RazuviousAI(Creature* pCreature) : CreatureAIScript(pCreature)
    {
        ...
        // Create basic info for spells here, and play with it later , fill always the info, targettype and if is instant or not!
        spells[0].info = sSpellCustomizations.GetServersideSpell(DISRUPTING_SHOUT);
        spells[0].targettype = TARGET_VARIOUS;
        spells[0].instant = false;
        spells[0].perctrigger = 15.0f;
        spells[0].attackstoptimer = 3000; // 1sec

        spells[1].info = sSpellCustomizations.GetServersideSpell(UNBALANCING_STRIKE);
...
class KorthazzAI : public CreatureAIScript
{
    ...
    KorthazzAI(Creature* pCreature) : CreatureAIScript(pCreature)
    {
        ...
        // Create basic info for spells here, and play with it later , fill always the info, targettype and if is instant or not!
        spells[0].info = sSpellCustomizations.GetServersideSpell(MARK_OF_KORTHAZZ);
        spells[0].targettype = TARGET_VARIOUS;
        spells[0].instant = false;
        spells[0].perctrigger = 5.0f;
        spells[0].attackstoptimer = 1000; // 1sec

        spells[1].info = sSpellCustomizations.GetServersideSpell(METEOR);
        spells[1].targettype = TARGET_ATTACKING;
        spells[1].instant = false;
        spells[1].perctrigger = 15.0f;
        spells[1].attackstoptimer = 3000; // 1sec
...
class BlaumeuxAI : public CreatureAIScript
{
    ...
    BlaumeuxAI(Creature* pCreature) : CreatureAIScript(pCreature)
    {
        ...
        // Create basic info for spells here, and play with it later , fill always the info, targettype and if is instant or not!
        spells[0].info = sSpellCustomizations.GetServersideSpell(MARK_OF_BLAUMEUX);
        spells[0].targettype = TARGET_VARIOUS;
        spells[0].instant = false;
        spells[0].perctrigger = 5.0f;
        spells[0].attackstoptimer = 1000; // 1sec

        spells[1].info = sSpellCustomizations.GetServersideSpell(VOID_ZONE);
        spells[1].targettype = TARGET_VARIOUS;
        spells[1].instant = false;
        spells[1].perctrigger = 15.0f;
        spells[1].attackstoptimer = 3000; // 1sec
...
class ZeliekAI : public CreatureAIScript
{
    ...
    ZeliekAI(Creature* pCreature) : CreatureAIScript(pCreature)
    {
        ...
        // Create basic info for spells here, and play with it later , fill always the info, targettype and if is instant or not!
        spells[0].info = sSpellCustomizations.GetServersideSpell(MARK_OF_ZELIEK);
        spells[0].targettype = TARGET_VARIOUS;
        spells[0].instant = false;
        spells[0].perctrigger = 5.0f;
        spells[0].attackstoptimer = 1000; // 1sec

        spells[1].info = sSpellCustomizations.GetServersideSpell(HOLY_WRATH);
        spells[1].targettype = TARGET_ATTACKING;
        spells[1].instant = false;
        spells[1].perctrigger = 15.0f;
        spells[1].attackstoptimer = 1000; // 1sec
...
class ChillTriggerAI : public CreatureAIScript
{
    ...
    {
        _unit->CastSpellAoF(_unit->GetPositionX(), _unit->GetPositionY(), _unit->GetPositionZ(), sSpellCustomizations.GetServersideSpell(28547), true);
        _unit->SetUInt64Value(UNIT_FIELD_FLAGS, UNIT_FLAG_NOT_ATTACKABLE_2);
        _unit->GetAIInterface()->disable_melee = true;
        _unit->GetAIInterface()->m_canMove = false;
        _unit->m_noRespawn = true;
...
class SapphironAI : public CreatureAIScript
{
    ...
    SapphironAI(Creature* pCreature) : CreatureAIScript(pCreature)
    {
        ...
        spells[0].info = sSpellCustomizations.GetServersideSpell(LIFE_DRAIN);
        spells[0].targettype = TARGET_VARIOUS;
        ...
        spells[1].info = sSpellCustomizations.GetServersideSpell(CHILL);
        ...
        spells[2].info = sSpellCustomizations.GetServersideSpell(ICEBOLT);
        ...
        spells[3].info = sSpellCustomizations.GetServersideSpell(BERSERK);
...
class KelthuzadAI : public CreatureAIScript
{
    ...
    KelthuzadAI(Creature* pCreature) : CreatureAIScript(pCreature)
    {
        ...
        spells[0].info = sSpellCustomizations.GetServersideSpell(SFROSTBOLT);
        spells[0].targettype = TARGET_ATTACKING;
        spells[0].instant = false;
        ...
        spells[1].info = sSpellCustomizations.GetServersideSpell(MFROSTBOLT);
        spells[1].targettype = TARGET_VARIOUS;
        spells[1].instant = true;
        ...
        spells[2].info = sSpellCustomizations.GetServersideSpell(CHAINS_OF_KELTHUZAD);
        spells[2].targettype = TARGET_RANDOM_SINGLE;
        spells[2].instant = true;
        spells[2].perctrigger = 5.0f;
        ...
        spells[3].info = sSpellCustomizations.GetServersideSpell(DETONATE_MANA);
        ...
        spells[4].info = sSpellCustomizations.GetServersideSpell(SHADOW_FISSURE);
        ...
        spells[5].info = sSpellCustomizations.GetServersideSpell(FROST_BLAST);
        ...
        spells[6].info = sSpellCustomizations.GetServersideSpell(KELTHUZAD_CHANNEL);
...
class UnstoppableAbominationAI : public CreatureAIScript
{
    ...
    UnstoppableAbominationAI(Creature* pCreature) : CreatureAIScript(pCreature)
    {
        ...
        spells[0].info = sSpellCustomizations.GetServersideSpell(UA_MORTAL_WOUND);
        spells[0].targettype = TARGET_ATTACKING;
        spells[0].instant = true;
...
class SoulWeaverAI : public CreatureAIScript
{
    ...
    SoulWeaverAI(Creature* pCreature) : CreatureAIScript(pCreature)
    {
        ...
        spells[0].info = sSpellCustomizations.GetServersideSpell(WAIL_OF_SOULS);
        spells[0].targettype = TARGET_VARIOUS;
        spells[0].instant = true;
        spells[0].cooldown = 10;
        spells[0].perctrigger = 15.0f;
...
class GuardianOfIcecrownAI : public CreatureAIScript
{
    ...
    GuardianOfIcecrownAI(Creature* pCreature) : CreatureAIScript(pCreature)
    {
        ...
        spells[0].info = sSpellCustomizations.GetServersideSpell(BLOOD_TAP);
        spells[0].targettype = TARGET_SELF;
        spells[0].instant = true;
        spells[0].cooldown = 0;
        spells[0].perctrigger = 0.0f;
