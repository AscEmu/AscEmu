...
class CoilfangChampionAI : public CreatureAIScript
{
    public:
        ...
        CoilfangChampionAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(INTIMIDATING_SHOUT);
...
class CoilfangObserverAI : public CreatureAIScript
{
    public:
        ...
        CoilfangObserverAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(IMMOLATE);
            spells[0].targettype = TARGET_ATTACKING;
...
class CoilfangDefenderAI : public CreatureAIScript
{
    public:
        ...
        CoilfangDefenderAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(REFLECTIVE_SHIELD);
            spells[0].targettype = TARGET_ATTACKING;
...
class CoilfangScaleHealerAI : public CreatureAIScript
{
    public:
        ...
        CoilfangScaleHealerAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(HOLY_NOVA);
            ...
            spells[2].info = sSpellCustomizations.GetServersideSpell(GREATER_HEAL);
...
class CoilfangSoothsayerAI : public CreatureAIScript
{
    public:
        ...
        CoilfangSoothsayerAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(MIND_CONTROL);
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = true;
...
class CoilfangRayAI : public CreatureAIScript
{
    public:
        ...
        CoilfangRayAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(HOWL_OF_TERROR);
            spells[0].targettype = TARGET_VARIOUS;
            spells[0].instant = false;
            spells[0].cooldown = 20;
...
class MennuTheBetrayerAI : public CreatureAIScript
{
    public:
        ...
        MennuTheBetrayerAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(LIGHTNING_BOLT);
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = false;
            spells[0].cooldown = 15;
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(MENNUS_HEALING_WARD);
            spells[1].targettype = TARGET_SELF;
            spells[1].instant = true;
            spells[1].cooldown = 20;
            ...
            spells[2].info = sSpellCustomizations.GetServersideSpell(TAINTED_EARTHGRAB_TOTEM);
            spells[2].targettype = TARGET_SELF;
            ...
            spells[3].info = sSpellCustomizations.GetServersideSpell(TAINTED_STONESKIN_TOTEM);
            ...
            spells[4].info = sSpellCustomizations.GetServersideSpell(CORRUPTED_NOVA_TOTEM);
...
class RokmarTheCracklerAI : public CreatureAIScript
{
    public:
        ...
        RokmarTheCracklerAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(GRIEVOUS_WOUND);
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = true;
            spells[0].cooldown = 20;
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(WATER_SPIT);
            ...
            spells[2].info = sSpellCustomizations.GetServersideSpell(ENSNARING_MOSS);
...
class QuagmirranAI : public CreatureAIScript
{
    public:
        ...
        QuagmirranAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(ACID_GEYSER);
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(POISON_BOLT_VOLLEY);
            spells[1].targettype = TARGET_VARIOUS;
            spells[1].instant = true;
            spells[1].cooldown = 10;
