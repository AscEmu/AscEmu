                    ...
                    if (Channeler && !Channeler->isAlive() && Channeler->IsInWorld())
                    {
                        ...
                        for (size_t x = 0; x < ChannelersTable.size(); x++)
                        {
                            ...
                            if (BuffedChanneler && BuffedChanneler != Channeler && BuffedChanneler->isAlive())
                            {
                                ...
                                Aura* aura = sSpellFactoryMgr.NewAura(sSpellCustomizations.GetServersideSpell(SOUL_TRANSFER), (uint32) - 1, BuffedChanneler, BuffedChanneler);
...
class ManticronCubeGO : public GameObjectAIScript
{
    public:
        ...
        void OnActivate(Player* pPlayer)
        {
            ...
            pPlayer->CastSpell(pPlayer, sSpellCustomizations.GetServersideSpell(SHADOW_GRASP2), false);
        ...
        void AIUpdate()
        {
            ...
            {
                Magtheridon->CastSpell(Magtheridon, sSpellCustomizations.GetServersideSpell(BANISH), true);
                ...
                Aura* aura = sSpellFactoryMgr.NewAura(sSpellCustomizations.GetServersideSpell(MIND_EXHAUSTION), (uint32)78000, Magtheridon, Channeler);
...
class HellfireWarderAI : public CreatureAIScript
{
    public:
        ...
        HellfireWarderAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(HW_SHADOW_BOLT_VOLLEY);
            ...
            spells[3].info = sSpellCustomizations.GetServersideSpell(DEATH_COIL);
            ...
            spells[4].info = sSpellCustomizations.GetServersideSpell(RAIN_OF_FIRE);
            ...
            spells[5].info = sSpellCustomizations.GetServersideSpell(HW_FEAR);
            ...
            spells[6].info = sSpellCustomizations.GetServersideSpell(SHADOW_BURST);
...
class HellfireChannelerAI : public CreatureAIScript
{
    public:
        ...
        HellfireChannelerAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(FEAR);
            spells[1].targettype = TARGET_RANDOM_SINGLE;
            ...
            spells[2].info = sSpellCustomizations.GetServersideSpell(DARK_MENDING);
            ...
            spells[3].info = sSpellCustomizations.GetServersideSpell(BURNING_ABYSSAL);
            spells[3].targettype = TARGET_RANDOM_SINGLE;
            spells[3].instant = true;
            ...
            spells[4].info = sSpellCustomizations.GetServersideSpell(SOUL_TRANSFER);
...
class BurningAbyssalAI : public CreatureAIScript
{
    public:
        ...
        BurningAbyssalAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(FIRE_BLAST);
...
class MagtheridonAI : public CreatureAIScript
{
    public:
        ...
        MagtheridonAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(CONFLAGRATION);
            spells[1].targettype = TARGET_RANDOM_SINGLE;
            spells[1].instant = true;
            spells[1].perctrigger = 7.0f;
            spells[1].attackstoptimer = 1000;
            ...
            spells[2].info = sSpellCustomizations.GetServersideSpell(QUAKE1);
            spells[2].targettype = TARGET_VARIOUS;
            spells[2].instant = true;

            spells[3].info = sSpellCustomizations.GetServersideSpell(QUAKE2);
            spells[3].targettype = TARGET_VARIOUS;
            spells[3].instant = true;

            spells[4].info = sSpellCustomizations.GetServersideSpell(BLAST_NOVA);
            spells[4].targettype = TARGET_VARIOUS;
            spells[4].instant = false;

            spells[5].info = sSpellCustomizations.GetServersideSpell(CAVE_IN);
            spells[5].instant = true;

            spells[6].info = sSpellCustomizations.GetServersideSpell(ENRAGE);
            spells[6].targettype = TARGET_SELF;
            spells[6].instant = true;

            _unit->SetUInt64Value(UNIT_FIELD_FLAGS, UNIT_FLAG_NOT_ATTACKABLE_9);

            Aura* aura = sSpellFactoryMgr.NewAura(sSpellCustomizations.GetServersideSpell(BANISHMENT), (uint32) - 1, _unit, _unit);
            _unit->AddAura(aura);

            _unit->CastSpell(_unit, sSpellCustomizations.GetServersideSpell(BANISH), true);
            _unit->GetAIInterface()->SetAllowedToEnterCombat(false);
        ...
        void PhaseTwo()
        {
            ...
            if (timer_blastNova > 33 && _unit->GetCurrentSpell() == NULL && !aura)
            {
                ...
                _unit->CastSpell(_unit, sSpellCustomizations.GetServersideSpell(BLAST_NOVA), false);
            ...
            {
                _unit->CastSpell(_unit, sSpellCustomizations.GetServersideSpell(ENRAGE), true);
        ...
        void PhaseThree()
        {
            ...
            if (timer_caveIn && (timer_caveIn != 1 || (_unit->GetCurrentSpell() == NULL && timer_caveIn == 1 && !aura)))
            {
                ...
                if (timer_caveIn == 2)
                {
                    ...
                    _unit->CastSpell(_unit, sSpellCustomizations.GetServersideSpell(CAMERA_SHAKE), true);
                    return;
                }
