...
class BigBadWolfAI : public CreatureAIScript
{
    public:
        ...
        BigBadWolfAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(TERRIFYING_HOWL);
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(WIDE_SWIPE);
            ...
            spells[2].info = sSpellCustomizations.GetServersideSpell(REDRIDINGHOOD_DEBUFF);
            ...
            spells[3].info = sSpellCustomizations.GetServersideSpell(PBS_TAUNT);
...
class THEBIGBADWOLFAI : public CreatureAIScript
{
    public:
        ...
        THEBIGBADWOLFAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(MORPH_LITTLE_RED_RIDING_HOOD);
            spells[1].targettype = TARGET_ATTACKING;
            spells[1].instant = true;
            ...
            spells[2].info = sSpellCustomizations.GetServersideSpell(DEBUFF_LITTLE_RED_RIDING_HOOD);
...
class CuratorAI : public CreatureAIScript
{
    public:
        ...
        CuratorAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(HATEFUL_BOLT);
            spells[0].instant = true;
            spells[0].cooldown = 12;

            spells[1].info = sSpellCustomizations.GetServersideSpell(BERSERK);
            spells[1].instant = true;
            spells[1].cooldown = 720;
            spells[1].attackstoptimer = 1000;

            spells[2].info = sSpellCustomizations.GetServersideSpell(EVOCATION);
            spells[2].instant = false;
            spells[2].cooldown = 0;
            spells[2].attackstoptimer = 19000;

            spells[3].info = sSpellCustomizations.GetServersideSpell(C_ENRAGE);
            spells[3].instant = true;
            spells[3].cooldown = 0;
            spells[3].attackstoptimer = 1000;
...
class ShadeofAranAI : public CreatureAIScript
{
    public:
        ...
        ShadeofAranAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(FIREBALL);
            ...
            spells[2].info = sSpellCustomizations.GetServersideSpell(ARCMISSLE);
            spells[2].targettype = TARGET_RANDOM_SINGLE;
            spells[2].instant = false;
            ...
            spells[3].info = sSpellCustomizations.GetServersideSpell(CHAINSOFICE);
            spells[3].targettype = TARGET_RANDOM_SINGLE;
            spells[3].instant = true;
            ...
            spells[4].info = sSpellCustomizations.GetServersideSpell(DRAGONSBREATH);
            ...
            spells[5].info = sSpellCustomizations.GetServersideSpell(AOE_COUNTERSPELL);
            ...
            info_flame_wreath = sSpellCustomizations.GetServersideSpell(FLAME_WREATH);
            info_blink_center = sSpellCustomizations.GetServersideSpell(BLINK_CENTER);
            info_massslow = sSpellCustomizations.GetServersideSpell(MASSSLOW);
            info_magnetic_pull = sSpellCustomizations.GetServersideSpell(MAGNETIC_PULL);
            info_aexplosion = sSpellCustomizations.GetServersideSpell(AEXPLOSION);
            info_blizzard = sSpellCustomizations.GetServersideSpell(BLIZZARD);
            info_summon_elemental_1 = sSpellCustomizations.GetServersideSpell(SUMMON_ELEMENTAL_1);
            info_summon_elemental_2 = sSpellCustomizations.GetServersideSpell(SUMMON_ELEMENTAL_2);
            info_summon_elemental_3 = sSpellCustomizations.GetServersideSpell(SUMMON_ELEMENTAL_3);
            info_mass_polymorph = sSpellCustomizations.GetServersideSpell(MASS_POLYMORPH);
            info_conjure = sSpellCustomizations.GetServersideSpell(CONJURE);
            info_drink = sSpellCustomizations.GetServersideSpell(DRINK);
            info_pyroblast = sSpellCustomizations.GetServersideSpell(AOE_PYROBLAST);
...
class IllhoofAI : public CreatureAIScript
{
    public:
        ...
        IllhoofAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(I_ENRAGE);
            ...
            spells[1].attackstoptimer = 1000;
            /*
                    spells[2].info = sSpellCustomizations.GetServersideSpell(S_DEMONCHAINS);
        ...
        void AIUpdate()
        {
            ...
            if (_unit->GetCurrentSpell() == NULL && _unit->GetAIInterface()->getNextTarget())
            {
                ...
                {
                    ReSummon = false;
                    _unit->CastSpell(_unit, sSpellCustomizations.GetServersideSpell(S_KILREK), true);
        ...
        void PlrSacrifice()
        {
            ...
            _unit->CastSpell(random_target, sSpellCustomizations.GetServersideSpell(SACRIFICE), false);
...
class KilrekAI : public CreatureAIScript
{
    public:
        ...
        KilrekAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(AMPLIFY_FLAMES);
            spells[0].targettype = TARGET_RANDOM_SINGLE;
            spells[0].instant = true;
            spells[0].cooldown = 5;
            spells[0].perctrigger = 50.0f;
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(BROKEN_PACT);
            spells[1].targettype = TARGET_ATTACKING;
            spells[1].instant = true;
        }
...
class FiendishImpAI : public CreatureAIScript
{
    public:
        ...
        FiendishImpAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(FIREBALL_IMP);
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = false;
            spells[0].cooldown = 0;
...
class DemonChains : public CreatureAIScript
{
    public:
        ...
        {
            _unit->CastSpell(_unit, sSpellCustomizations.GetServersideSpell(CHAINS_VISUAL), true);
            _unit->Root();
            _unit->DisableAI();
        }
...
class MalchezaarAI : public MoonScriptCreatureAI
{
    public:
        ...
        MalchezaarAI(Creature* pCreature) : MoonScriptCreatureAI(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(SW_PAIN);
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = true;
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(ENFEEBLE);
            ...
            spells[2].info = sSpellCustomizations.GetServersideSpell(INF_RAIN);
            ...
            spells[3].info = sSpellCustomizations.GetServersideSpell(SUNDER_ARMOR);
            ...
            spells[4].info = sSpellCustomizations.GetServersideSpell(AMPLIFY_DMG);
            spells[4].targettype = TARGET_RANDOM_SINGLE;
            spells[4].instant = true;
            ...
            spells[5].info = sSpellCustomizations.GetServersideSpell(SHADOWNOVA);
            ...
            spells[6].info = sSpellCustomizations.GetServersideSpell(THRASH_AURA);
            ...
            spells[7].info = sSpellCustomizations.GetServersideSpell(WIELD_AXES);
            spells[7].targettype = TARGET_SELF;
            spells[7].instant = true;
            spells[7].attackstoptimer = 1000;

            spells[8].info = sSpellCustomizations.GetServersideSpell(SUMMON_AXES);
...
class NetherInfernalAI : public MoonScriptBossAI
{
    public:
        ...
        void OnLoad()
        {
            ...
            Despawn(175000, 0);
            _unit->CastSpell(_unit, sSpellCustomizations.GetServersideSpell(HELLFIRE), true);
            ParentClass::OnLoad();
        };
...
class MAxesAI : public CreatureAIScript
{
    public:
        ...
        MAxesAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(DEMONIC_FRENZY);
...
class NetherspiteAI : public CreatureAIScript
{
    public:
        ...
        NetherspiteAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(NETHERBREATH);
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = false;
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(N_BERSERK);
            spells[1].targettype = TARGET_SELF;
            spells[1].instant = true;
            ...
            spells[2].info = sSpellCustomizations.GetServersideSpell(NETHERBURN);
...
class VoidZoneAI : public CreatureAIScript
{
    public:
        ...
        VoidZoneAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(CONSUMPTION);
            spells[0].instant = true;
            spells[0].cooldown = 2;
            spells[0].casttime = (uint32)time(NULL) + spells[0].cooldown;
...
class NightbaneAI : public CreatureAIScript
{
    public:
        ...
        NightbaneAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            //ground phase spells
            spells[0].info =  sSpellCustomizations.GetServersideSpell(BELLOWING_ROAR);
            spells[0].targettype = TARGET_VARIOUS;
            spells[0].instant = false;
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(CHARRED_EARTH);
            spells[1].targettype = TARGET_RANDOM_SINGLE;
            spells[1].instant = false;
            ...
            spells[2].info = sSpellCustomizations.GetServersideSpell(CLEAVE);
            spells[2].targettype = TARGET_ATTACKING;
            spells[2].instant = false;
            spells[2].cooldown = 7;
            spells[2].perctrigger = 0.0f;
            ...
            spells[3].info = sSpellCustomizations.GetServersideSpell(DISTRACTING_ASH);
            spells[3].targettype = TARGET_RANDOM_SINGLE;
            ...
            spells[4].info = sSpellCustomizations.GetServersideSpell(SMOLDERING_BREATH);
        ...
        void FlyPhase()
        {
            ...
            if (m_FlyPhaseTimer == 15)
            {
                ...
                //summon 3 skeletons
                //_unit->CastSpellAoF(target->GetPositionX(),target->GetPositionY(),target->GetPositionZ(), sSpellCustomizations.GetServersideSpell(SUMMON_BONE_SKELETONS), true);
                return;
            }
            ...
            {
                target = _unit->GetAIInterface()->getNextTarget();
                _unit->CastSpell(target, sSpellCustomizations.GetServersideSpell(SMOKING_BLAST), true);
            }
            ...
            for (std::set<Object*>::iterator itr = _unit->GetInRangeSetBegin(); itr != _unit->GetInRangeSetEnd(); ++itr)
            {
                if ((*itr)->IsPlayer())
                {
                    ...
                    {
                        _unit->CastSpellAoF(target->GetPositionX(), target->GetPositionY(), target->GetPositionZ(), sSpellCustomizations.GetServersideSpell(FIREBALL_BARRAGE), true);
                        break; //stop
                    }
                }
            }
                ...
                for (std::set<Object*>::iterator itr = _unit->GetInRangeSetBegin(); itr != _unit->GetInRangeSetEnd(); ++itr)
                {
                    if ((*itr)->IsPlayer())
                    {
                        ...
                        if (target->isAlive() && target->isInBack(_unit))
                            _unit->CastSpell(target, sSpellCustomizations.GetServersideSpell(TAIL_SWEEP), true);
                    }
                }
                mTailSweepTimer = 25;
            }
...
class DorotheeAI : public CreatureAIScript
{
    public:
        ...
        DorotheeAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(SP_AOE_FEAR);
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = true;
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(SP_WATER_BOLT);
            spells[1].targettype = TARGET_RANDOM_SINGLE;
            spells[1].instant = false;
...
class TitoAI : public CreatureAIScript
{
    public:
        ...
        TitoAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(SP_ANNOYING_YIPPING);
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = true;
...
class StrawmanAI : public CreatureAIScript
{
    public:
        ...
        StrawmanAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(SP_BURNING_STRAW);//  NEEDS TO BE SO IT ONLY AFFECTS HIM WHEN HE IS HIT BY FIRE DMG!
            spells[0].targettype = TARGET_SELF;
            spells[0].instant = true;
            spells[0].perctrigger = 0.0f;
            spells[0].attackstoptimer = 1000;

            spells[1].info = sSpellCustomizations.GetServersideSpell(SP_BRAIN_BASH);
            spells[1].targettype = TARGET_RANDOM_SINGLE;
            spells[1].instant = true;
...
class TinheadAI : public CreatureAIScript
{
    public:
        ...
        TinheadAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(SP_CLEAVE);
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = true;
            spells[0].perctrigger = 0.0f;
            spells[0].attackstoptimer = 1000;

            spells[1].info = sSpellCustomizations.GetServersideSpell(SP_RUST);
            spells[1].targettype = TARGET_SELF;
            spells[1].instant = true;
...
class CroneAI : public CreatureAIScript
{
    public:
        ...
        CroneAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(SP_SUMMON_CYCLONE);
            spells[0].targettype = TARGET_DESTINATION;
            spells[0].instant = true;
            spells[0].perctrigger = 5.0f;
            spells[0].attackstoptimer = 1000;

            spells[1].info = sSpellCustomizations.GetServersideSpell(SP_CHAIN_LIGHTNING);
            spells[1].targettype = TARGET_ATTACKING;
            spells[1].instant = true;
...
class CycloneOZ : public CreatureAIScript
{
    public:
        ...
        {
            _unit->CastSpell(_unit, sSpellCustomizations.GetServersideSpell(CYCLONE_VISUAL), true);
            _unit->SetUInt32Value(UNIT_FIELD_FLAGS, UNIT_FLAG_NOT_ATTACKABLE_2);
            _unit->GetAIInterface()->disable_melee = true;
            _unit->GetAIInterface()->m_canMove = false;
            _unit->m_noRespawn = true;
        ...
        void AIUpdate()
        {
            _unit->CastSpell(_unit, sSpellCustomizations.GetServersideSpell(CYCLONE_KNOCK), true);
        }
};
...
class RomuloAI : public CreatureAIScript
{
    public:
        ...
        RomuloAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(SP_BACKWARD_LUNGE);
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = false;
            spells[0].cooldown = 12;
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(SP_DEADLY_SWATHE);
            spells[1].targettype = TARGET_ATTACKING;
            spells[1].instant = false;
            spells[1].cooldown = 0;
            ...
            spells[2].info = sSpellCustomizations.GetServersideSpell(SP_POISONED_THRUST);
            spells[2].targettype = TARGET_ATTACKING;
            spells[2].instant = false;
            spells[2].cooldown = 0;
            ...
            spells[3].info = sSpellCustomizations.GetServersideSpell(SP_DARING);
...
class JulianneAI : public CreatureAIScript
{
    public:
        ...
        JulianneAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(SP_ETERNAL_AFFECTION);
            spells[0].targettype = TARGET_SELF;
            spells[0].instant = false;
            spells[0].cooldown = 12;
            spells[0].perctrigger = 5.0f;
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(SP_POWERFUL_ATTRACTION);
            spells[1].targettype = TARGET_ATTACKING;
            spells[1].instant = false;
            spells[1].cooldown = 0;
            ...
            spells[2].info = sSpellCustomizations.GetServersideSpell(SP_BINDING_PASSION);
            spells[2].targettype = TARGET_ATTACKING;
            spells[2].instant = false;
            spells[2].cooldown = 0;
            ...
            spells[3].info = sSpellCustomizations.GetServersideSpell(SP_DEVOTION);
            spells[3].targettype = TARGET_SELF;
            spells[3].instant = false;
            spells[3].cooldown = 0;
