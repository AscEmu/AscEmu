...
class DeepfuryAI : public CreatureAIScript
{
    public:
        ...
        {
            m_spellcheck = false;
            spell.info = sSpellCustomizations.GetServersideSpell(KAM_SHIELDSLAM);
...
class HamhockAI : public CreatureAIScript
{
    public:
        ...
        HamhockAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(CHAINLIGHT);
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(DEMORALIZO);
...
class BazilAI : public CreatureAIScript
{
    public:
        ...
        {
            m_spellcheck = false;
            spell.info = sSpellCustomizations.GetServersideSpell(BAZILBOMB);
...
class DextrenAI : public CreatureAIScript
{
    public:
        ...
        {
            m_spellcheck = false;
            spell.info = sSpellCustomizations.GetServersideSpell(INTIMIDATING);
            spell.targettype = TARGET_ATTACKING;
            spell.instant = true;
            spell.perctrigger = 0.0f;
            spell.cooldown = 15;
...
class InmateAI : public CreatureAIScript
{
    public:
        ...
        {
            m_spellcheck = false;
            spell.info = sSpellCustomizations.GetServersideSpell(CONVICTREND);
            spell.targettype = TARGET_ATTACKING;
            spell.instant = true;
            spell.perctrigger = 0.0f;
            spell.cooldown = 12;
...
class InsurgentAI : public CreatureAIScript
{
    public:
        ...
        {
            m_spellcheck = false;
            spell.info = sSpellCustomizations.GetServersideSpell(INSURGENTDEMORALIZO);
...
class PrisonerAI : public CreatureAIScript
{
    public:
        ...
        PrisonerAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(PRISONKICK);
            spells[0].targettype = TARGET_ATTACKING;
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(PRISONDISARM);
            spells[1].targettype = TARGET_ATTACKING;
            spells[1].instant = true;
            spells[1].perctrigger = 0.0f;
...
class ConvictAI : public CreatureAIScript
{
    public:
        ...
        {
            m_spellcheck = false;
            spell.info = sSpellCustomizations.GetServersideSpell(CONVICTBACKHAND);
            spell.targettype = TARGET_ATTACKING;
            spell.instant = true;
            spell.perctrigger = 0.0f;
            spell.cooldown = 10;
