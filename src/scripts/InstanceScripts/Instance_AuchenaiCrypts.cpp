...
class InstanceAuchenaiCryptsScript : public MoonInstanceScript
{
    public:

        MOONSCRIPT_INSTANCE_FACTORY_FUNCTION(InstanceAuchenaiCryptsScript, MoonInstanceScript);
        InstanceAuchenaiCryptsScript(MapMgr* pMapMgr) : MoonInstanceScript(pMapMgr)
        {
...
{
    //Instance
    mgr->register_instance_script(MAP_AUCHENAI_CRYPT, &InstanceAuchenaiCryptsScript::Create);
