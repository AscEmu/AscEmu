...
class MograineAI : public CreatureAIScript
{
    public:
        ...
        MograineAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(SP_MORGRAINE_SHIELD);
            spells[0].targettype = TARGET_SELF;
            spells[0].instant = true;
            spells[0].perctrigger = 5.0f;
            spells[0].attackstoptimer = 1000;

            spells[1].info = sSpellCustomizations.GetServersideSpell(SP_MORGRAINE_HAMMER);
            spells[1].targettype = TARGET_ATTACKING;
            spells[1].instant = true;
            spells[1].perctrigger = 10.0f;
            spells[1].attackstoptimer = 1000;

            spells[2].info = sSpellCustomizations.GetServersideSpell(SP_MORGRAINE_CRUSADER);
...
class WhitemaneAI : public CreatureAIScript
{
    public:
        ...
        WhitemaneAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(SP_WHITEMANE_SMITE);
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = false;
            spells[0].perctrigger = 15.0f;
            spells[0].attackstoptimer = 1000;

            spells[1].info = sSpellCustomizations.GetServersideSpell(SP_WHITEMANE_SLEEP);
            spells[1].targettype = TARGET_ATTACKING;
            spells[1].instant = true;
            spells[1].perctrigger = 0.0f;
            spells[1].attackstoptimer = 1000;

            spells[2].info = sSpellCustomizations.GetServersideSpell(SP_WHITEMANE_RESURRECTION);
...
class FairbanksAI : public CreatureAIScript
{
    public:
        ...
        FairbanksAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(SP_FAIRBANKS_BLOOD);
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = true;
            spells[0].perctrigger = 15.0f;
            spells[0].attackstoptimer = 1000;

            spells[1].info = sSpellCustomizations.GetServersideSpell(SP_FAIRBANKS_PWS);
