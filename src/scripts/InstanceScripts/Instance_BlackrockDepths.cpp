...
//////////////////////////////////////////////////////////////////////////////////////////
//Blackrock Depths
class InstanceBlackrockDepthsScript : public MoonInstanceScript
{
    public:

        MOONSCRIPT_INSTANCE_FACTORY_FUNCTION(InstanceBlackrockDepthsScript, MoonInstanceScript);
        InstanceBlackrockDepthsScript(MapMgr* pMapMgr) : MoonInstanceScript(pMapMgr)
        {
...
class AmbassadorFlamelash : public CreatureAIScript
{
    public:
        ...
        {
            spell.info = sSpellCustomizations.GetServersideSpell(15573);
...
class AnubShiah : public CreatureAIScript
{
    public:
        ...
        AnubShiah(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(11661);
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(15471);
...
class BaelGar : public CreatureAIScript
{
    public:
        ...
        BaelGar(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(13879);
            spells[0].cooldown = 10;
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = true;
            spells[0].perctrigger = RandomFloat(20.0f);
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(13895);
            spells[1].cooldown = 10;
            spells[1].targettype = TARGET_ATTACKING;
            spells[1].instant = true;
            spells[1].perctrigger = RandomFloat(20.0f);
...
class EmperorDagranThaurissan : public CreatureAIScript
{
    public:
        ...
        EmperorDagranThaurissan(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(17492);
            spells[0].cooldown = 10;
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = true;
            spells[0].perctrigger = RandomFloat(20.0f);
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(24573);
            spells[1].cooldown = 10;
            spells[1].targettype = TARGET_ATTACKING;
            spells[1].instant = true;
            spells[1].perctrigger = RandomFloat(20.0f);
...
class Eviscerator : public CreatureAIScript
{
    public:
        ...
        Eviscerator(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(14331);
            spells[0].cooldown = 10;
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = true;
            spells[0].perctrigger = RandomFloat(20.0f);
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(20741);
            spells[1].cooldown = 10;
            spells[1].targettype = TARGET_ATTACKING;
            spells[1].instant = true;
            spells[1].perctrigger = RandomFloat(20.0f);
...
class FineousDarkvire : public CreatureAIScript
{
    public:
        ...
        FineousDarkvire(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(15614);
            spells[0].cooldown = 10;
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = true;
            spells[0].perctrigger = RandomFloat(20.0f);
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(13953);
            spells[1].cooldown = 10;
            spells[1].targettype = TARGET_ATTACKING;
            spells[1].instant = true;
            spells[1].perctrigger = RandomFloat(20.0f);
...
class GeneralAngerforge : public CreatureAIScript
{
    public:
        ...
        GeneralAngerforge(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(14099);
            spells[0].cooldown = 10;
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = true;
            spells[0].perctrigger = RandomFloat(20.0f);
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(9080);
            spells[1].cooldown = 10;
            spells[1].targettype = TARGET_ATTACKING;
            spells[1].instant = true;
            spells[1].perctrigger = RandomFloat(20.0f);
...
class GolemLordArgelmach : public CreatureAIScript
{
    public:
        ...
        GolemLordArgelmach(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(16033);
            spells[0].cooldown = 10;
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = true;
            spells[0].perctrigger = RandomFloat(20.0f);
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(16034);
            spells[1].cooldown = 10;
            spells[1].targettype = TARGET_ATTACKING;
            spells[1].instant = true;
            spells[1].perctrigger = RandomFloat(20.0f);
            ...
            spells[2].info = sSpellCustomizations.GetServersideSpell(10432);
            spells[2].cooldown = 10;
...
class GoroshTheDervish : public CreatureAIScript
{
    public:
        ...
        GoroshTheDervish(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(15589);
            spells[0].cooldown = 10;
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = true;
            spells[0].perctrigger = RandomFloat(20.0f);
...
class Grizzle : public CreatureAIScript
{
    public:
        ...
        Grizzle(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(6524);
            spells[0].cooldown = 10;
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = true;
            spells[0].perctrigger = RandomFloat(20.0f);
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(20691);
            spells[1].cooldown = 10;
            spells[1].targettype = TARGET_ATTACKING;
            spells[1].instant = true;
            spells[1].perctrigger = RandomFloat(20.0f);
...
class HedrumTheCreeper : public CreatureAIScript
{
    public:
        ...
        HedrumTheCreeper(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(15475);
            spells[0].cooldown = 10;
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = true;
            spells[0].perctrigger = RandomFloat(20.0f);
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(15474);
            spells[1].cooldown = 10;
            spells[1].targettype = TARGET_ATTACKING;
            spells[1].instant = true;
            spells[1].perctrigger = RandomFloat(20.0f);
            ...
            spells[2].info = sSpellCustomizations.GetServersideSpell(3609);
            spells[2].cooldown = 10;
            spells[2].targettype = TARGET_ATTACKING;
            spells[2].instant = true;
            spells[2].perctrigger = RandomFloat(20.0f);
...
class HighInterrogatorGerstahn : public CreatureAIScript
{
    public:
        ...
        HighInterrogatorGerstahn(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(8122);
            spells[1].cooldown = 10;
            spells[1].targettype = TARGET_ATTACKING;
            spells[1].instant = true;
            spells[1].perctrigger = RandomFloat(20.0f);
            ...
            spells[2].info = sSpellCustomizations.GetServersideSpell(10876);
            spells[2].cooldown = 10;
            spells[2].targettype = TARGET_ATTACKING;
            spells[2].instant = true;
            spells[2].perctrigger = RandomFloat(20.0f);
...
class HoundmasterGrebmar : public CreatureAIScript
{
    public:
        ...
        HoundmasterGrebmar(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(23511);
            spells[0].cooldown = 10;
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = true;
            spells[0].perctrigger = RandomFloat(20.0f);
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(17153);
            spells[1].cooldown = 10;
            spells[1].targettype = TARGET_ATTACKING;
            spells[1].instant = true;
            spells[1].perctrigger = RandomFloat(20.0f);
...
class HurleyBlackbreath : public CreatureAIScript
{
    public:
        ...
        HurleyBlackbreath(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(17294);
            spells[0].cooldown = 10;
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = true;
            spells[0].perctrigger = RandomFloat(20.0f);
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(15583);
            spells[1].cooldown = 10;
            spells[1].targettype = TARGET_ATTACKING;
            spells[1].instant = true;
            spells[1].perctrigger = RandomFloat(20.0f);
            ...
            spells[2].info = sSpellCustomizations.GetServersideSpell(14099);
            spells[2].cooldown = 10;
            spells[2].targettype = TARGET_ATTACKING;
            spells[2].instant = true;
            spells[2].perctrigger = RandomFloat(20.0f);
...
class LordIncendius : public CreatureAIScript
{
    public:
        ...
        LordIncendius(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(13899);
            spells[0].cooldown = 10;
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = true;
            spells[0].perctrigger = RandomFloat(20.0f);
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(13900);
            spells[1].cooldown = 10;
            spells[1].targettype = TARGET_ATTACKING;
            spells[1].instant = true;
            spells[1].perctrigger = RandomFloat(20.0f);
...
class LordRoccor : public CreatureAIScript
{
    public:
        ...
        LordRoccor(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(10448);
            spells[0].cooldown = 10;
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = true;
            spells[0].perctrigger = RandomFloat(20.0f);
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(6524);
            spells[1].cooldown = 10;
            spells[1].targettype = TARGET_ATTACKING;
            spells[1].instant = true;
            spells[1].perctrigger = RandomFloat(20.0f);
            ...
            spells[2].info = sSpellCustomizations.GetServersideSpell(10414);
            spells[2].cooldown = 10;
            spells[2].targettype = TARGET_ATTACKING;
            spells[2].instant = true;
            spells[2].perctrigger = RandomFloat(20.0f);
...
class Magmus : public CreatureAIScript
{
    public:
        ...
        Magmus(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(13900);
            spells[0].cooldown = 10;
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = true;
            spells[0].perctrigger = RandomFloat(20.0f);
...
class OkThorTheBreaker : public CreatureAIScript
{
    public:
        ...
        OkThorTheBreaker(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(15453);
            spells[0].cooldown = 10;
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = true;
            spells[0].perctrigger = RandomFloat(20.0f);
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(15451);
            spells[1].cooldown = 10;
            spells[1].targettype = TARGET_ATTACKING;
            spells[1].instant = true;
            spells[1].perctrigger = RandomFloat(20.0f);
...
class Phalanx : public CreatureAIScript
{
    public:
        ...
        Phalanx(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(8732);
            spells[0].cooldown = 10;
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = true;
            spells[0].perctrigger = RandomFloat(20.0f);
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(22425);
            spells[1].cooldown = 10;
            spells[1].targettype = TARGET_ATTACKING;
            spells[1].instant = true;
            spells[1].perctrigger = RandomFloat(20.0f);
...
class PyromancerLoregrain : public CreatureAIScript
{
    public:
        ...
        PyromancerLoregrain(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(15095);
            spells[1].cooldown = 10;
            spells[1].targettype = TARGET_ATTACKING;
            spells[1].instant = true;
            spells[1].perctrigger = RandomFloat(20.0f);
...
{
    //Instance
    mgr->register_instance_script(MAP_BLACKROCK_DEPTHS, &InstanceBlackrockDepthsScript::Create);
