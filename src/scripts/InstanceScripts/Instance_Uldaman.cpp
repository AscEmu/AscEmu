...
//////////////////////////////////////////////////////////////////////////////////////////
//Uldaman
class InstanceUldamanScript : public MoonInstanceScript
{
    public:

        MOONSCRIPT_INSTANCE_FACTORY_FUNCTION(InstanceUldamanScript, MoonInstanceScript);
        InstanceUldamanScript(MapMgr* pMapMgr) : MoonInstanceScript(pMapMgr)
        {
...
class Archaedas : public CreatureAIScript
{
    public:
        ...
        {
            spell.info = sSpellCustomizations.GetServersideSpell(6524);
            spell.cooldown = 10;
...
class Revelosh : public CreatureAIScript
{
    public:
        ...
        Revelosh(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(10392);
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(2860);
...
class Grimlok : public CreatureAIScript
{
    public:
        ...
        Grimlok(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(8292);
            spells[0].cooldown = 10;
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = true;
            spells[0].perctrigger = RandomFloat(20.0f);
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(10392);
            spells[1].cooldown = 10;
            spells[1].targettype = TARGET_ATTACKING;
            spells[1].instant = true;
            spells[1].perctrigger = RandomFloat(20.0f);
            ...
            spells[2].info = sSpellCustomizations.GetServersideSpell(8066);
...
class Baelog : public CreatureAIScript
{
    public:
        ...
        Baelog(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(15613);
            spells[0].cooldown = 10;
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = true;
            spells[0].perctrigger = RandomFloat(20.0f);
...
class GalgannFirehammer : public CreatureAIScript
{
    public:
        ...
        GalgannFirehammer(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(18958);
            spells[1].cooldown = 10;
            spells[1].targettype = TARGET_ATTACKING;
            spells[1].instant = true;
            spells[1].perctrigger = RandomFloat(20.0f);
            ...
            spells[2].info = sSpellCustomizations.GetServersideSpell(12470);
            spells[2].cooldown = 10;
            spells[2].targettype = TARGET_ATTACKING;
            spells[2].instant = true;
            spells[2].perctrigger = RandomFloat(20.0f);
...
class Ironaya : public CreatureAIScript
{
    public:
        ...
        Ironaya(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(16169);
            spells[0].cooldown = 10;
            spells[0].targettype = TARGET_ATTACKING;
            spells[0].instant = true;
            spells[0].perctrigger = RandomFloat(20.0f);
...
{
    //Instance
    mgr->register_instance_script(MAP_ULDAMAN, &InstanceUldamanScript::Create);
