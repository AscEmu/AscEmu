...
class ChronoLordAI : public CreatureAIScript
{
    public:
        ...
        ChronoLordAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(ARCANE_BLAST);
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(TIME_LAPSE);
...
class TemporusAI : public CreatureAIScript
{
    public:
        ...
        TemporusAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(HASTEN);
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(MORTAL_WOUND);
            spells[1].targettype = TARGET_ATTACKING;
            spells[1].instant = true;
            spells[1].cooldown = 5;
            spells[1].perctrigger = 0.0f;
...
class AenusAI : public CreatureAIScript
{
    public:
        ...
        AenusAI(Creature* pCreature) : CreatureAIScript(pCreature)
        {
            ...
            spells[0].info = sSpellCustomizations.GetServersideSpell(SAND_BREATH);
            ...
            spells[1].info = sSpellCustomizations.GetServersideSpell(TIME_STOP);
