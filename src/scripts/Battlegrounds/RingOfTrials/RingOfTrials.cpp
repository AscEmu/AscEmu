...
void RingOfTrials::OnCreate()
{
    ...
    obj = createGameObject(183979, LocationVector(4090.064453f, 2858.437744f, 10.236313f, 0.492805f), 32, 1375, 1.0f);
    obj->setState(GO_STATE_CLOSED);
    obj->setLocalRotation(0.f, 0.f, 0.243916f, 0.969796f);
    obj->PushToWorld(m_mapMgr);

    obj = createGameObject(183980, LocationVector(4081.178955f, 2874.970459f, 12.391714f, 0.492805f), 32, 1375, 1.0f);
    obj->setState(GO_STATE_CLOSED);
    obj->setLocalRotation(0.f, 0.f, 0.243916f, 0.969796f);
    m_gates.insert(obj);

    obj = createGameObject(183977, LocationVector(4023.709473f, 2981.776611f, 10.701169f, -2.648788f), 32, 1375, 1.0f);
    obj->setState(GO_STATE_CLOSED);
    obj->setLocalRotation(0.f, 0.f, 0.969796f, -0.243916f);
    obj->PushToWorld(m_mapMgr);

    obj = createGameObject(183978, LocationVector(4031.854248f, 2966.833496f, 12.646200f, -2.648788f), 32, 1375, 1.0f);
    obj->setState(GO_STATE_CLOSED);
    obj->setLocalRotation(0.f, 0.f, 0.969796f, -0.243916f);
    m_gates.insert(obj);
...
{
    m_buffs[0] = createGameObject(184664, LocationVector(4011.113232f, 2896.879980f, 12.523950f, 0.486944f), 32, 1375, 1.0f);
    ...
    m_buffs[1] = createGameObject(184664, LocationVector(4102.111426f, 2945.843262f, 12.662578f, 3.628544f), 32, 1375, 1.0f);
