...
void SetupMiscCreatures(ScriptMgr* mgr)
{
    ...
    // Hippogryph Master
    uint32 HippogryphMasterIds[] = { 3838, 3841, 4267, 4319, 4407, 6706, 8019, 9605, 10897, 11138, 11800, 12577, 12578,
    ...
    // Wyvern Master
    uint32 WyvernMasterIds[] = { 1387, 2851, 2858, 2861, 2995, 3305, 3310, 3615, 4012, 4312, 4314, 4317, 6026, 6726,
    ...
    // Bat Master
    uint32 BatMasterIds[] = { 2226, 2389, 4551, 12636, 3575, 23816, 24155, 26844, 26845, 27344, 27842, 37915, 41142, /*Rocket*/ 35141, 0 };

    mgr->register_creature_script(BatMasterIds, &HordeBat::Create);

    // Dragonhawk Masters
    uint32 DragonhawkMasterIds[] = { 16189, 16192, 24795, 26560, 26851, 27046, 30269, 0 };
