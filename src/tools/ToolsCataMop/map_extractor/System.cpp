...
uint32_t const Builds[] = { 16016, 16048, 16057, 16309, 16357, 16516, 16650, 16844, 16965, 17116, 17266, 17325, 17345, 17538, 17645, 17688, 17898, 18273 };
#endif
...
static uint32_t const MAP_VERSION_MAGIC = 4;
