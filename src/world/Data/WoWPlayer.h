...
struct WoWPlayer : WoWUnit
{
    ...
    float_t field_mod_damage_done_pct[WOWPLAYER_SPELL_SCHOOL_COUNT];
    uint32_t field_mod_healing_done;
    float_t field_mod_healing_pct;
    float_t field_mod_healing_done_pct;
    float_t weapon_dmg_multiplier[3];
    float_t mod_spell_power_pct;
    float_t override_spell_power_by_ap_pct;
    uint32_t field_mod_target_resistance;
    uint32_t field_mod_target_physical_resistance;
    uint32_t field_bytes;
    uint32_t self_resurrection_spell;
    ...
    float_t ui_hit_mod;
    float_t ui_hit_spell_mod;
    uint32_t ui_home_realm_time_offset;
    float_t mod_haste;
    float_t mod_ranged_haste;
    float_t mod_pet_haste;
    float_t mod_haste_regen;
};
#endif
#pragma pack(pop)
