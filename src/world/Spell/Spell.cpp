            ...
            else
            {
                ...
                switch (GetSpellInfo()->custom_NameHash)
                {
                    ...
                    */
                    ...
                    {
                        if (u_caster->m_specialState & (UNIT_STATE_FEAR | UNIT_STATE_CHARM))
                            break;
                    }
                    break;
                    ...
                    {
                        if (u_caster->m_specialState & UNIT_STATE_FEAR)
                            break;
                    }
                    break;
                    ...
                    {
                        if (u_caster->m_specialState & (UNIT_STATE_FEAR | UNIT_STATE_CHARM | UNIT_STATE_STUN | UNIT_STATE_CONFUSE) || u_caster->HasUnitMovementFlag(MOVEFLAG_ROOTED))
                            break;
                    }
                    break;
                    ...
                    case SPELL_HASH_BARKSKIN:
                    {
                        ...
                        if (u_caster->m_specialState & (UNIT_STATE_STUN | UNIT_STATE_FEAR))     // Uh, what unit_state is Frozen? (freezing trap...)
                            break;
                    }
                    break;
                    ...
                    {
                        if (u_caster->m_specialState & (UNIT_STATE_FEAR | UNIT_STATE_STUN | UNIT_STATE_SILENCE))
                            break;
                    }
                    break;
