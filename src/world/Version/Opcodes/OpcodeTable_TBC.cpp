...
// Hex values of the internal opcode ids for TBC clients. Opcodes without an entry do not exist in this version.

#include "Version/OpcodeTable.hpp"

namespace Version::Tables
{
    // TBC: 1059 opcodes with a hex value in this client version
    static const OpcodeEntry tbcOpcodeEntries[] =
    {
        { CMSG_BOOTME, 0x0001 },
    ...
    const OpcodeSource tbcOpcodes{ tbcOpcodeEntries, std::size(tbcOpcodeEntries) };
}
