...
// Hex values of the internal opcode ids for Classic clients. Opcodes without an entry do not exist in this version.

#include "Version/OpcodeTable.hpp"

namespace Version::Tables
{
    // Classic: 1059 opcodes with a hex value in this client version
    static const OpcodeEntry classicOpcodeEntries[] =
    {
        { CMSG_BOOTME, 0x0001 },
        ...
        { SMSG_INIT_EXTRA_AURA_INFO, 0x03A3 },
        { SMSG_SET_EXTRA_AURA_INFO, 0x03A4 },
        { SMSG_SET_EXTRA_AURA_INFO_NEED_UPDATE, 0x03A5 },
        { SMSG_CLEAR_EXTRA_AURA_INFO, 0x03A6 },
        ...
        { SMSG_VOICE_PARENTAL_CONTROLS, 0x03B0 },
        { CMSG_GM_WHISPER, 0x03B1 },
        { SMSG_GM_MESSAGECHAT, 0x03B2 },
        { MSG_GM_GEARRATING, 0x03B3 },
        { CMSG_COMMENTATOR_ENABLE, 0x03B4 },
        { SMSG_COMMENTATOR_STATE_CHANGED, 0x03B5 },
        { CMSG_COMMENTATOR_GET_MAP_INFO, 0x03B6 },
        { SMSG_COMMENTATOR_MAP_INFO, 0x03B7 },
        { CMSG_COMMENTATOR_GET_PLAYER_INFO, 0x03B8 },
        { SMSG_COMMENTATOR_GET_PLAYER_INFO, 0x03B9 },
        { SMSG_COMMENTATOR_PLAYER_INFO, 0x03BA },
        { CMSG_COMMENTATOR_ENTER_INSTANCE, 0x03BB },
        { CMSG_COMMENTATOR_EXIT_INSTANCE, 0x03BC },
        { CMSG_COMMENTATOR_INSTANCE_COMMAND, 0x03BD },
        { SMSG_CLEAR_TARGET, 0x03BE },
        { CMSG_BOT_DETECTED, 0x03BF },
        { SMSG_CROSSED_INEBRIATION_THRESHOLD, 0x03C0 },
        { CMSG_CHEAT_PLAYER_LOGIN, 0x03C1 },
        { CMSG_CHEAT_PLAYER_LOOKUP, 0x03C2 },
        { SMSG_CHEAT_PLAYER_LOOKUP, 0x03C3 },
        { SMSG_KICK_REASON, 0x03C4 },
        { MSG_RAID_READY_CHECK_FINISHED, 0x03C5 },
        { CMSG_COMPLAIN, 0x03C6 },
        { SMSG_COMPLAIN_RESULT, 0x03C7 },
        { SMSG_FEATURE_SYSTEM_STATUS, 0x03C8 },
        { CMSG_GM_SHOW_COMPLAINTS, 0x03C9 },
        { CMSG_GM_UNSQUELCH, 0x03CA },
        { CMSG_CHANNEL_SILENCE_VOICE, 0x03CB },
        { CMSG_CHANNEL_SILENCE_ALL, 0x03CC },
        { CMSG_CHANNEL_UNSILENCE_VOICE, 0x03CD },
        { CMSG_CHANNEL_UNSILENCE_ALL, 0x03CE },
        { CMSG_TARGET_CAST, 0x03CF },
        { CMSG_TARGET_SCRIPT_CAST, 0x03D0 },
        { CMSG_CHANNEL_DISPLAY_LIST, 0x03D1 },
        { CMSG_SET_ACTIVE_VOICE_CHANNEL, 0x03D2 },
        { CMSG_GET_CHANNEL_MEMBER_COUNT, 0x03D3 },
        { SMSG_CHANNEL_MEMBER_COUNT, 0x03D4 },
        { CMSG_CHANNEL_VOICE_ON, 0x03D5 },
        { CMSG_CHANNEL_VOICE_OFF, 0x03D6 },
        { CMSG_DEBUG_LIST_TARGETS, 0x03D7 },
        { SMSG_DEBUG_LIST_TARGETS, 0x03D8 },
        { SMSG_AVAILABLE_VOICE_CHANNEL, 0x03D9 },
        { CMSG_ADD_VOICE_IGNORE, 0x03DA },
        { CMSG_DEL_VOICE_IGNORE, 0x03DB },
        { CMSG_PARTY_SILENCE, 0x03DC },
        { CMSG_PARTY_UNSILENCE, 0x03DD },
        { MSG_NOTIFY_PARTY_SQUELCH, 0x03DE },
        { SMSG_COMSAT_RECONNECT_TRY, 0x03DF },
        { SMSG_COMSAT_DISCONNECT, 0x03E0 },
        { SMSG_COMSAT_CONNECT_FAIL, 0x03E1 },
        { SMSG_VOICE_CHAT_STATUS, 0x03E2 },
        { CMSG_REPORT_PVP_AFK, 0x03E3 },
        { CMSG_REPORT_PVP_AFK_RESULT, 0x03E4 },
        { CMSG_GUILD_BANKER_ACTIVATE, 0x03E5 },
        { CMSG_GUILD_BANK_QUERY_TAB, 0x03E6 },
        { SMSG_GUILD_BANK_LIST, 0x03E7 },
        { CMSG_GUILD_BANK_SWAP_ITEMS, 0x03E8 },
        { CMSG_GUILD_BANK_BUY_TAB, 0x03E9 },
        { CMSG_GUILD_BANK_UPDATE_TAB, 0x03EA },
        { CMSG_GUILD_BANK_DEPOSIT_MONEY, 0x03EB },
        { CMSG_GUILD_BANK_WITHDRAW_MONEY, 0x03EC },
        { MSG_GUILD_BANK_LOG_QUERY, 0x03ED },
        { CMSG_SET_CHANNEL_WATCH, 0x03EE },
        { SMSG_USERLIST_ADD, 0x03EF },
        { SMSG_USERLIST_REMOVE, 0x03F0 },
        { SMSG_USERLIST_UPDATE, 0x03F1 },
        { CMSG_CLEAR_CHANNEL_WATCH, 0x03F2 },
        { SMSG_INSPECT_TALENT, 0x03F3 },
        { SMSG_GOGOGO_OBSOLETE, 0x03F4 },
        { SMSG_ECHO_PARTY_SQUELCH, 0x03F5 },
        { CMSG_SET_TITLE_SUFFIX, 0x03F6 },
        { CMSG_SPELL_CLICK, 0x03F7 },
        { SMSG_LOOT_LIST, 0x03F8 },
        { CMSG_GM_CHARACTER_RESTORE, 0x03F9 },
        { CMSG_GM_CHARACTER_SAVE, 0x03FA },
        { SMSG_VOICESESSION_FULL, 0x03FB },
        { MSG_GUILD_PERMISSIONS, 0x03FC },
        { MSG_GUILD_BANK_MONEY_WITHDRAWN, 0x03FD },
        { MSG_GUILD_EVENT_LOG_QUERY, 0x03FE },
        { CMSG_MAELSTROM_RENAME_GUILD, 0x03FF },
        { CMSG_GET_MIRRORIMAGE_DATA, 0x0400 },
        { SMSG_MIRRORIMAGE_DATA, 0x0401 },
        { SMSG_FORCE_DISPLAY_UPDATE, 0x0402 },
        { SMSG_SPELL_CHANCE_RESIST_PUSHBACK, 0x0403 },
        { CMSG_IGNORE_DIMINISHING_RETURNS_CHEAT, 0x0404 },
        { SMSG_IGNORE_DIMINISHING_RETURNS_CHEAT, 0x0405 },
        { CMSG_KEEP_ALIVE, 0x0406 },
        { SMSG_RAID_READY_CHECK_ERROR, 0x0407 },
        { CMSG_OPT_OUT_OF_LOOT, 0x0408 },
        { MSG_QUERY_GUILD_BANK_TEXT, 0x0409 },
        { CMSG_SET_GUILD_BANK_TEXT, 0x040A },
        { CMSG_SET_GRANTABLE_LEVELS, 0x040B },
        { CMSG_GRANT_LEVEL, 0x040C },
        { CMSG_REFER_A_FRIEND, 0x040D },
        { MSG_GM_CHANGE_ARENA_RATING, 0x040E },
        { CMSG_DECLINE_CHANNEL_INVITE, 0x040F },
        { CMSG_GROUPACTION_THROTTLED, 0x0410 },
        { SMSG_OVERRIDE_LIGHT, 0x0411 },
        { SMSG_TOTEM_CREATED, 0x0412 },
        { CMSG_TOTEM_DESTROYED, 0x0413 },
        { CMSG_EXPIRE_RAID_INSTANCE, 0x0414 },
        { CMSG_NO_SPELL_VARIANCE, 0x0415 },
        { CMSG_QUEST_GIVER_STATUS_MULTIPLE_QUERY, 0x0416 },
        { SMSG_QUESTGIVER_STATUS_MULTIPLE, 0x0417 },
        { CMSG_SET_PLAYER_DECLINED_NAMES, 0x0418 },
        { SMSG_SET_PLAYER_DECLINED_NAMES_RESULT, 0x0419 },
        { CMSG_QUERY_SERVER_BUCK_DATA, 0x041A },
        { CMSG_CLEAR_SERVER_BUCK_DATA, 0x041B },
        { SMSG_SERVER_BUCK_DATA, 0x041C },
        { SMSG_SEND_UNLEARN_SPELLS, 0x041D },
        { SMSG_PROPOSE_LEVEL_GRANT, 0x041E },
        { CMSG_ACCEPT_LEVEL_GRANT, 0x041F },
        { SMSG_REFER_A_FRIEND_FAILURE, 0x0420 },
        { SMSG_SPLINE_MOVE_UNSET_FLYING, 0x0422 },
        { SMSG_SUMMON_CANCEL, 0x0423 },
        { SMSG_SPLINE_MOVE_SET_FLYING, 0x0421 },
    };

    const OpcodeSource classicOpcodes{ classicOpcodeEntries, std::size(classicOpcodeEntries) };
}
