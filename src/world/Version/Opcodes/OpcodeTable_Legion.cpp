...
// Hex values of the internal opcode ids for Legion clients. Opcodes without an entry do not exist in this version.

#include "Version/OpcodeTable.hpp"

namespace Version::Tables
{
    // Legion: 1723 opcodes with a hex value in this client version
    static const OpcodeEntry legionOpcodeEntries[] =
    {
        { SMSG_PETGODMODE, 0x26A4 },
        { SMSG_GODMODE, 0x2738 },
        { CMSG_CHAR_CREATE, 0x3643 },
        { CMSG_ENUM_CHARACTERS, 0x35E8 },
        { CMSG_CHAR_DELETE, 0x369B },
        { SMSG_CHAR_CREATE, 0x273E },
        { SMSG_ENUM_CHARACTERS_RESULT, 0x2582 },
        { SMSG_CHAR_DELETE, 0x273F },
        ...
        { SMSG_GAMETIME_UPDATE, 0x274A },
        { SMSG_GAMETIME_SET, 0x274B },
        { SMSG_GAMESPEED_SET, 0x26AA },
        { SMSG_SERVERTIME, 0x26AB },
        ...
        { CMSG_PET_NAME_QUERY, 0x3267 },
        { SMSG_PET_NAME_QUERY_RESPONSE, 0x2702 },
        { CMSG_GUILD_QUERY, 0x368D },
        { SMSG_GUILD_QUERY_RESPONSE, 0x29E5 },
        { CMSG_PAGE_TEXT_QUERY, 0x3266 },
        { SMSG_PAGE_TEXT_QUERY_RESPONSE, 0x2700 },
        { CMSG_QUEST_QUERY, 0x3265 },
        { SMSG_QUEST_QUERY_RESPONSE, 0x2A95 },
        { CMSG_GAMEOBJECT_QUERY, 0x3263 },
        { SMSG_GAMEOBJECT_QUERY_RESPONSE, 0x26FB },
        { CMSG_CREATURE_QUERY, 0x3262 },
        { SMSG_CREATURE_QUERY_RESPONSE, 0x26FA },
        { CMSG_WHO, 0x3681 },
        { SMSG_WHO, 0x2BAE },
        { CMSG_WHOIS, 0x3680 },
        { SMSG_WHOIS, 0x26CE },
        { CMSG_CONTACT_LIST, 0x36CE },
        ...
        { CMSG_GROUP_INVITE, 0x3602 },
        { SMSG_GROUP_INVITE, 0x25CF },
        { SMSG_GROUP_DECLINE, 0x27D3 },
        { CMSG_GROUP_UNINVITE_GUID, 0x3647 },
        { SMSG_GROUP_UNINVITE, 0x27D4 },
        { CMSG_GROUP_SET_LEADER, 0x364A },
        { SMSG_GROUP_SET_LEADER, 0x2649 },
        { CMSG_LOOT_METHOD, 0x3648 },
        { SMSG_GROUP_DESTROYED, 0x27D5 },
        { SMSG_GROUP_LIST, 0x260B },
        { SMSG_PARTY_MEMBER_STATS, 0x279B },
        { SMSG_PARTY_COMMAND_RESULT, 0x27D7 },
        { CMSG_GUILD_INVITE, 0x3606 },
        { SMSG_GUILD_INVITE, 0x29CA },
        { CMSG_GUILD_ACCEPT, 0x35FC },
        { CMSG_GUILD_DECLINE, 0x3060 },
        { CMSG_GUILD_ROSTER, 0x3073 },
        { SMSG_GUILD_ROSTER, 0x29BB },
        { CMSG_GUILD_LEAVE, 0x3062 },
        { CMSG_GUILD_REMOVE, 0x3063 },
        { CMSG_GUILD_DISBAND, 0x3068 },
        { CMSG_GUILD_LEADER, 0x36C5 },
        { CMSG_GUILD_MOTD, 0x3074 },
        { SMSG_GUILD_COMMAND_RESULT, 0x29BA },
        { CMSG_JOIN_CHANNEL, 0x37C8 },
        { CMSG_LEAVE_CHANNEL, 0x37C9 },
        { SMSG_CHANNEL_NOTIFY, 0x2BC0 },
        { CMSG_CHANNEL_LIST, 0x37D9 },
        { SMSG_CHANNEL_LIST, 0x2BC3 },
        { CMSG_CHANNEL_PASSWORD, 0x37DB },
        { CMSG_CHANNEL_SET_OWNER, 0x37DC },
        { CMSG_CHANNEL_OWNER, 0x37DD },
        { CMSG_CHANNEL_MODERATOR, 0x37DF },
        { CMSG_CHANNEL_UNMODERATOR, 0x37E0 },
        { CMSG_CHANNEL_MUTE, 0x37E1 },
        { CMSG_CHANNEL_UNMUTE, 0x37E2 },
        { CMSG_CHANNEL_INVITE, 0x37E3 },
        { CMSG_CHANNEL_KICK, 0x37E4 },
        { CMSG_CHANNEL_BAN, 0x37E5 },
        { CMSG_CHANNEL_UNBAN, 0x37E6 },
        { CMSG_CHANNEL_ANNOUNCEMENTS, 0x37E7 },
        { CMSG_CHANNEL_MODERATE, 0x37DE },
        { SMSG_UPDATE_OBJECT, 0x280F },
        { CMSG_USE_ITEM, 0x328A },
        { CMSG_OPEN_ITEM, 0x3310 },
        { CMSG_READ_ITEM, 0x3311 },
        { SMSG_ITEM_COOLDOWN, 0x280B },
        { CMSG_GAMEOBJ_USE, 0x34F2 },
        { SMSG_GAMEOBJECT_CUSTOM_ANIM, 0x25D7 },
        { CMSG_AREATRIGGER, 0x31CD },
        { MSG_MOVE_START_FORWARD, 0x39E4 },
        { MSG_MOVE_START_BACKWARD, 0x39E5 },
        { MSG_MOVE_STOP, 0x39E6 },
        { MSG_MOVE_START_STRAFE_LEFT, 0x39E7 },
        { MSG_MOVE_START_STRAFE_RIGHT, 0x39E8 },
        { MSG_MOVE_STOP_STRAFE, 0x39E9 },
        { MSG_MOVE_JUMP, 0x39EA },
        { MSG_MOVE_START_TURN_LEFT, 0x39EC },
        { MSG_MOVE_START_TURN_RIGHT, 0x39ED },
        { MSG_MOVE_STOP_TURN, 0x39EE },
        { MSG_MOVE_START_PITCH_UP, 0x39EF },
        { MSG_MOVE_START_PITCH_DOWN, 0x39F0 },
        { MSG_MOVE_STOP_PITCH, 0x39F1 },
        { MSG_MOVE_SET_RUN_MODE, 0x39F2 },
        { MSG_MOVE_SET_WALK_MODE, 0x39F3 },
        { MSG_MOVE_TELEPORT, 0x2DD2 },
        { CMSG_MOVE_TELEPORT_ACK, 0x39F8 },
        { MSG_MOVE_FALL_LAND, 0x39F9 },
        { MSG_MOVE_START_SWIM, 0x39FA },
        { MSG_MOVE_STOP_SWIM, 0x39FB },
        { MSG_MOVE_SET_RUN_SPEED, 0x2DA4 },
        { MSG_MOVE_SET_RUN_BACK_SPEED, 0x2DA5 },
        { MSG_MOVE_SET_WALK_SPEED, 0x2DA6 },
        { MSG_MOVE_SET_SWIM_SPEED, 0x2DA7 },
        { MSG_MOVE_SET_SWIM_BACK_SPEED, 0x2DA8 },
        { MSG_MOVE_SET_TURN_RATE, 0x2DAB },
        { MSG_MOVE_TOGGLE_COLLISION_CHEAT, 0x3A05 },
        { MSG_MOVE_SET_FACING, 0x3A06 },
        { MSG_MOVE_SET_PITCH, 0x3A07 },
        { MSG_MOVE_WORLDPORT_ACK, 0x35F9 },
        { SMSG_MONSTER_MOVE, 0x2DA2 },
        { SMSG_FORCE_RUN_SPEED_CHANGE, 0x2DBE },
        { CMSG_FORCE_RUN_SPEED_CHANGE_ACK, 0x3A08 },
        { SMSG_FORCE_RUN_BACK_SPEED_CHANGE, 0x2DBF },
        { CMSG_FORCE_RUN_BACK_SPEED_CHANGE_ACK, 0x3A09 },
        { SMSG_FORCE_SWIM_SPEED_CHANGE, 0x2DC0 },
        { CMSG_FORCE_SWIM_SPEED_CHANGE_ACK, 0x3A0A },
        { CMSG_FORCE_MOVE_ROOT_ACK, 0x3A0B },
        { CMSG_FORCE_MOVE_UNROOT_ACK, 0x3A0C },
        { SMSG_MOVE_ROOT, 0x2DC7 },
        { SMSG_MOVE_UNROOT, 0x2DC8 },
        { MSG_MOVE_HEARTBEAT, 0x3A0D },
        ...
        { CMSG_STANDSTATECHANGE, 0x3188 },
        { CMSG_EMOTE, 0x3545 },
        { SMSG_EMOTE, 0x280D },
        { CMSG_TEXT_EMOTE, 0x348A },
        { SMSG_TEXT_EMOTE, 0x26A3 },
        { CMSG_AUTOSTORE_LOOT_ITEM, 0x3205 },
        { CMSG_AUTOEQUIP_ITEM, 0x399A },
        { CMSG_AUTOSTORE_BAG_ITEM, 0x399B },
        { CMSG_SWAP_ITEM, 0x399C },
        { CMSG_SWAP_INV_ITEM, 0x399D },
        { CMSG_SPLIT_ITEM, 0x399E },
        { CMSG_AUTOEQUIP_ITEM_SLOT, 0x399F },
        ...
        { CMSG_ATTACKSWING, 0x324C },
        { CMSG_ATTACK_STOP, 0x324D },
        { SMSG_ATTACK_START, 0x266D },
        { SMSG_ATTACK_STOP, 0x266E },
        { SMSG_ATTACKERSTATEUPDATE, 0x27CF },
        { SMSG_CANCEL_COMBAT, 0x2731 },
        { SMSG_SPELLHEALLOG, 0x2C1D },
        { SMSG_SPELLENERGIZELOG, 0x2C1C },
        { SMSG_BINDPOINTUPDATE, 0x257C },
        { SMSG_PLAYERBOUND, 0x257D },
        { SMSG_CLIENT_CONTROL_UPDATE, 0x2664 },
        ...
        { SMSG_LOOT_RELEASE_RESPONSE, 0x262F },
        { SMSG_LOOT_REMOVED, 0x2629 },
        { SMSG_LOOT_MONEY_NOTIFY, 0x2630 },
        { SMSG_LOOT_CLEAR_MONEY, 0x262B },
        { SMSG_ITEM_PUSH_RESULT, 0x2637 },
        { SMSG_DUEL_REQUESTED, 0x2670 },
        { SMSG_DUEL_OUTOFBOUNDS, 0x2671 },
        { SMSG_DUEL_INBOUNDS, 0x2672 },
        { SMSG_DUEL_COMPLETE, 0x2674 },
        { SMSG_DUEL_WINNER, 0x2675 },
        { CMSG_DUEL_RESPONSE, 0x34E6 },
        { SMSG_MOUNTRESULT, 0x257A },
        { SMSG_DISMOUNTRESULT, 0x257B },
        { CMSG_MOUNTSPECIAL_ANIM, 0x3273 },
        { SMSG_MOUNTSPECIAL_ANIM, 0x26C8 },
        ...
        { SMSG_PET_SPELLS, 0x2C25 },
        { SMSG_PET_MODE, 0x2589 },
        { CMSG_GOSSIP_HELLO, 0x3495 },
        { CMSG_GOSSIP_SELECT_OPTION, 0x3497 },
        { SMSG_GOSSIP_MESSAGE, 0x2A97 },
        { SMSG_GOSSIP_COMPLETE, 0x2A96 },
        { CMSG_NPC_TEXT_QUERY, 0x3264 },
        { CMSG_QUESTGIVER_STATUS_QUERY, 0x349F },
        { SMSG_QUESTGIVER_STATUS, 0x2A9A },
        { CMSG_QUESTGIVER_HELLO, 0x3499 },
        { SMSG_QUESTGIVER_QUEST_LIST, 0x2A99 },
        { CMSG_QUESTGIVER_QUERY_QUEST, 0x349A },
        { SMSG_QUESTGIVER_QUEST_DETAILS, 0x2A91 },
        { CMSG_QUESTGIVER_ACCEPT_QUEST, 0x349B },
        { CMSG_QUESTGIVER_COMPLETE_QUEST, 0x349C },
        { SMSG_QUESTGIVER_REQUEST_ITEMS, 0x2A92 },
        { CMSG_QUESTGIVER_REQUEST_REWARD, 0x349E },
        { SMSG_QUESTGIVER_OFFER_REWARD, 0x2A93 },
        { CMSG_QUESTGIVER_CHOOSE_REWARD, 0x349D },
        { SMSG_QUESTGIVER_QUEST_INVALID, 0x2A84 },
        { SMSG_QUESTGIVER_QUEST_COMPLETE, 0x2A82 },
        { SMSG_QUESTGIVER_QUEST_FAILED, 0x2A85 },
        { CMSG_QUESTLOG_REMOVE_QUEST, 0x3532 },
        { SMSG_QUESTLOG_FULL, 0x2A86 },
        { SMSG_QUESTUPDATE_FAILED, 0x2A89 },
        { SMSG_QUESTUPDATE_FAILEDTIMER, 0x2A8A },
        { SMSG_QUESTUPDATE_COMPLETE, 0x2A88 },
        { SMSG_QUESTUPDATE_ADD_KILL, 0x2A8B },
        { CMSG_QUEST_CONFIRM_ACCEPT, 0x34A1 },
        { SMSG_QUEST_CONFIRM_ACCEPT, 0x2A8E },
        { CMSG_PUSHQUESTTOPARTY, 0x34A2 },
        { CMSG_LIST_INVENTORY, 0x34A4 },
        { SMSG_LIST_INVENTORY, 0x25CA },
        { CMSG_SELL_ITEM, 0x34A5 },
        { SMSG_SELL_ITEM, 0x26EF },
        { CMSG_BUY_ITEM, 0x34A6 },
        { SMSG_BUY_ITEM, 0x26F0 },
        { SMSG_BUY_FAILED, 0x26F1 },
        { SMSG_SHOWTAXINODES, 0x26F6 },
        { CMSG_TAXINODE_STATUS_QUERY, 0x34AB },
        { SMSG_TAXINODE_STATUS, 0x26A5 },
        { CMSG_TAXIQUERYAVAILABLENODES, 0x34AD },
        ...
        { SMSG_SPELLLOGMISS, 0x2C41 },
        { SMSG_SPELLLOGEXECUTE, 0x2C40 },
        { SMSG_PERIODICAURALOG, 0x2C1B },
        { SMSG_SPELLDAMAGESHIELD, 0x2C31 },
        { SMSG_SPELLNONMELEEDAMAGELOG, 0x2C32 },
        { CMSG_LEARN_TALENT, 0x3556 },
        { CMSG_TOGGLE_PVP, 0x329C },
        { SMSG_ZONE_UNDER_ATTACK, 0x2BB5 },
        { CMSG_AUCTION_HELLO, 0x34CF },
        { SMSG_AUCTION_HELLO, 0x2723 },
        ...
        { SMSG_AUCTION_LIST_RESULT, 0x272A },
        { SMSG_AUCTION_OWNER_LIST_RESULT, 0x272B },
        { SMSG_AUCTION_OWNER_NOTIFICATION, 0x2729 },
        { SMSG_PROCRESIST, 0x279E },
        { SMSG_DISPEL_FAILED, 0x2C30 },
        { SMSG_SPELLORDAMAGE_IMMUNE, 0x2C2F },
        { CMSG_AUCTION_LIST_BIDDER_ITEMS, 0x34D5 },
        { SMSG_AUCTION_BIDDER_LIST_RESULT, 0x272C },
        ...
        { SMSG_LOOT_START_ROLL, 0x2631 },
        { SMSG_LOOT_ROLL, 0x2632 },
        { CMSG_LOOT_MASTER_GIVE, 0x3206 },
        { SMSG_LOOT_MASTER_LIST, 0x2633 },
        { SMSG_SET_FORCED_REACTIONS, 0x275C },
        { SMSG_SPELL_FAILED_OTHER, 0x2C54 },
        { SMSG_GAMEOBJECT_RESET_STATE, 0x275D },
        { CMSG_REPAIR_ITEM, 0x34F0 },
        { SMSG_CHAT_PLAYER_NOT_FOUND, 0x2BB7 },
        { MSG_TALENT_WIPE_CONFIRM, 0x3202 },
        ...
        { CMSG_SET_ACTIONBAR_TOGGLES, 0x3536 },
        { SMSG_INIT_WORLD_STATES, 0x278B },
        { SMSG_UPDATE_WORLD_STATE, 0x278C },
        { SMSG_ITEM_NAME_QUERY_RESPONSE, 0x25B1 },
        { SMSG_PET_ACTION_FEEDBACK, 0x278D },
        { CMSG_MOVE_SPLINE_DONE, 0x3A15 },
        { CMSG_MOVE_FALL_RESET, 0x3A16 },
        { SMSG_INSTANCE_SAVE_CREATED, 0x27BD },
        { SMSG_RAID_INSTANCE_INFO, 0x2650 },
        { CMSG_REQUEST_RAID_INFO, 0x36C7 },
        { CMSG_MOVE_FEATHER_FALL_ACK, 0x3A19 },
        { CMSG_MOVE_WATER_WALK_ACK, 0x3A1A },
        { SMSG_PLAY_SOUND, 0x27AA },
        { CMSG_BATTLEFIELD_STATUS, 0x35DC },
        { CMSG_BATTLEFIELD_PORT, 0x3529 },
        { CMSG_INSPECT_HONOR_STATS, 0x3179 },
        { SMSG_INSPECT_HONOR_STATS, 0x25B2 },
        { CMSG_BATTLEMASTER_HELLO, 0x32A1 },
        { SMSG_FORCE_WALK_SPEED_CHANGE, 0x2DC4 },
        { CMSG_FORCE_WALK_SPEED_CHANGE_ACK, 0x3A1E },
        { SMSG_FORCE_SWIM_BACK_SPEED_CHANGE, 0x2DC1 },
        { CMSG_FORCE_SWIM_BACK_SPEED_CHANGE_ACK, 0x3A1F },
        { SMSG_FORCE_TURN_RATE_CHANGE, 0x2DC5 },
        { CMSG_FORCE_TURN_RATE_CHANGE_ACK, 0x3A20 },
        { MSG_PVP_LOG_DATA, 0x317A },
        { SMSG_PVP_LOG_DATA, 0x25B3 },
        { CMSG_LEAVE_BATTLEFIELD, 0x3171 },
        ...
        { MSG_BATTLEGROUND_PLAYER_POSITIONS, 0x2595 },
        ...
        { CMSG_GUILD_INFO_TEXT, 0x3075 },
        { SMSG_CHAT_RESTRICTED, 0x2BB3 },
        { SMSG_SPLINE_MOVE_UNROOT, 0x2DE6 },
        { SMSG_SPLINE_MOVE_SET_HOVER, 0x2DED },
        { SMSG_SPLINE_MOVE_UNSET_HOVER, 0x2DEE },
        { SMSG_SPLINE_MOVE_START_SWIM, 0x2DF1 },
        { SMSG_SPLINE_MOVE_STOP_SWIM, 0x2DF2 },
        { SMSG_SPLINE_MOVE_SET_RUN_MODE, 0x2DF3 },
        { SMSG_SPLINE_MOVE_SET_WALK_MODE, 0x2DF4 },
        { SMSG_SET_FACTION_ATWAR, 0x273C },
        { CMSG_SET_FACTION_INACTIVE, 0x34E4 },
        { CMSG_SET_WATCHED_FACTION, 0x34E5 },
        { CMSG_MOVE_TIME_SKIPPED, 0x3A18 },
        { SMSG_SPLINE_MOVE_ROOT, 0x2DE5 },
        ...
        { MSG_RAID_TARGET_UPDATE, 0x3650 },
        { SMSG_RAID_TARGET_UPDATE_ALL, 0x264A },
        { SMSG_RAID_TARGET_UPDATE_SINGLE, 0x264B },
        { MSG_RAID_READY_CHECK, 0x3633 },
        { SMSG_RAID_READY_CHECK_CONFIRM, 0x260D },
        ...
        { MSG_MOVE_START_ASCEND, 0x3A26 },
        { MSG_MOVE_STOP_ASCEND, 0x3A27 },
        ...
        { MSG_MOVE_SET_FLIGHT_SPEED, 0x2DA9 },
        { MSG_MOVE_SET_FLIGHT_BACK_SPEED, 0x2DAA },
        { SMSG_FORCE_FLIGHT_SPEED_CHANGE, 0x2DC2 },
        { CMSG_FORCE_FLIGHT_SPEED_CHANGE_ACK, 0x3A2A },
        { SMSG_FORCE_FLIGHT_BACK_SPEED_CHANGE, 0x2DC3 },
        { CMSG_FORCE_FLIGHT_BACK_SPEED_CHANGE_ACK, 0x3A2B },
        { SMSG_FLIGHT_SPLINE_SYNC, 0x2DF7 },
        { CMSG_SET_TAXI_BENCHMARK_MODE, 0x34F7 },
        { CMSG_REALM_SPLIT, 0x36BB },
        { CMSG_MOVE_CHNG_TRANSPORT, 0x3A2C },
        ...
        { CMSG_CHANNEL_DISPLAY_LIST, 0x37DA },
        { CMSG_REPORT_PVP_AFK, 0x34F8 },
        { CMSG_GUILD_BANKER_ACTIVATE, 0x34B9 },
        { CMSG_GUILD_BANK_QUERY_TAB, 0x34C7 },
        { SMSG_GUILD_BANK_LIST, 0x29DE },
        ...
        { SMSG_GUILD_BANK_LOG_QUERY_RESULT, 0x29DF },
        ...
        { CMSG_GUILD_PERMISSIONS, 0x3084 },
        { SMSG_GUILD_PERMISSIONS_QUERY_RESULTS, 0x29E1 },
        { CMSG_GUILD_EVENT_LOG_QUERY, 0x3085 },
        { SMSG_GUILD_EVENT_LOG_QUERY_RESULT, 0x29E2 },
        { CMSG_GET_MIRRORIMAGE_DATA, 0x3289 },
        { CMSG_KEEP_ALIVE, 0x367F },
        { CMSG_OPT_OUT_OF_LOOT, 0x34FA },
        { MSG_QUERY_GUILD_BANK_TEXT, 0x29E3 },
        { CMSG_SET_GUILD_BANK_TEXT, 0x3086 },
        ...
        { SMSG_QUESTGIVER_STATUS_MULTIPLE, 0x2A90 },
        ...
        { SMSG_SPLINE_MOVE_UNSET_FLYING, 0x2DF6 },
        { SMSG_SUMMON_CANCEL, 0x26D8 },
        { SMSG_REFER_A_FRIEND_EXPIRED, 0x2762 },
        { SMSG_DESTRUCTIBLE_BUILDING_DAMAGE, 0x2732 },
        { SMSG_EQUIPMENT_SET_SAVED, 0x26DC },
        { CMSG_EQUIPMENT_SET_DELETE, 0x3510 },
        ...
        { CMSG_CALENDAR_EVENT_REMOVE_INVITE, 0x3673 },
        ...
        { SMSG_CALENDAR_EVENT_MODERATOR_STATUS_ALERT, 0x26BB },
        { CMSG_CALENDAR_COMPLAIN, 0x3679 },
        { CMSG_CALENDAR_GET_NUM_PENDING, 0x367A },
        { SMSG_CALENDAR_SEND_NUM_PENDING, 0x26C5 },
        { MSG_MOVE_SET_PITCH_RATE, 0x2DAC },
        { SMSG_FORCE_PITCH_RATE_CHANGE, 0x2DC6 },
        { CMSG_FORCE_PITCH_RATE_CHANGE_ACK, 0x3A2F },
        ...
        { SMSG_QUESTUPDATE_ADD_PVP_KILL, 0x2A8D },
        ...
        { CMSG_GAMEOBJ_REPORT_USE, 0x34F3 },
        ...
        { SMSG_AUCTION_LIST_PENDING_SALES, 0x272D },
        { SMSG_MODIFY_COOLDOWN, 0x27A6 },
        { CMSG_ENABLETAXI, 0x34AC },
        { SMSG_PRE_RESURRECT, 0x27A9 },
        { SMSG_AURA_UPDATE, 0x2C22 },
        { SMSG_SERVER_FIRST_ACHIEVEMENT, 0x2BBC },
        { SMSG_PET_LEARNED_SPELL, 0x2C4F },
        ...
        { SMSG_PLAYER_VEHICLE_DATA, 0x272F },
        { CMSG_PLAYER_VEHICLE_ENTER, 0x322F },
        { CMSG_EJECT_PASSENGER, 0x3230 },
        { SMSG_PET_GUIDS, 0x2741 },
        { SMSG_CLIENTCACHE_VERSION, 0x2742 },
        { SMSG_ITEMREFUNDINFO, 0x25B0 },
        { CMSG_ITEMREFUNDINFO, 0x3533 },
        { SMSG_ITEMREFUNDREQUEST, 0x25AF },
        { CMSG_CALENDAR_EVENT_SIGNUP, 0x367B },
        { SMSG_CALENDAR_CLEAR_PENDING_ACTION, 0x26C6 },
        { CMSG_EQUIPMENT_SET_SAVE, 0x350F },
        { CMSG_UPDATE_PROJECTILE_POSITION, 0x3189 },
        { SMSG_UPDATE_TALENT_DATA, 0x25EB },
        { SMSG_ARENA_UNIT_DESTROYED, 0x2784 },
        { SMSG_MULTIPLE_PACKETS, 0x3051 },
        { SMSG_MOVE_GRAVITY_DISABLE, 0x2DDB },
        { CMSG_MOVE_GRAVITY_DISABLE_ACK, 0x3A32 },
        { SMSG_MOVE_GRAVITY_ENABLE, 0x2DDC },
        { CMSG_MOVE_GRAVITY_ENABLE_ACK, 0x3A33 },
        { SMSG_SPLINE_MOVE_GRAVITY_DISABLE, 0x2DE7 },
        { SMSG_SPLINE_MOVE_GRAVITY_ENABLE, 0x2DE8 },
        { CMSG_EQUIPMENT_SET_USE, 0x3995 },
        { SMSG_EQUIPMENT_SET_USE_RESULT, 0x2792 },
        { SMSG_FORCE_ANIM, 0x2794 },
        { CMSG_CHAR_FACTION_CHANGE, 0x3694 },
        { CMSG_SET_RAID_DIFFICULTY, 0x36DB },
        { SMSG_SET_RAID_DIFFICULTY, 0x27EF },
        { SMSG_TALENTS_INVOLUNTARILY_RESET, 0x2756 },
        { SMSG_CORPSE_NOT_IN_INSTANCE, 0x2755 },
        { SMSG_CONNECT_TO, 0x304D },
        { SMSG_SUSPEND_COMMS, 0x304A },
        { CMSG_SUSPEND_COMMS_ACK, 0x3764 },
        { SMSG_FORCE_SEND_QUEUED_PACKETS, 0x304B },
        { SMSG_OPEN_LFG_DUNGEON_FINDER, 0x2A31 },
        { SMSG_MOVE_SET_COLLISION_HGT, 0x2DDF },
        { CMSG_MOVE_SET_COLLISION_HEIGHT_ACK, 0x3A36 },
        { CMSG_ADDON_REGISTERED_PREFIXES, 0x37CD },
        { CMSG_BATTLE_PET_DELETE_PET, 0x3624 },
        { CMSG_BATTLE_PET_MODIFY_NAME, 0x3627 },
        { CMSG_BATTLE_PET_QUERY_NAME, 0x3268 },
        ...
        { CMSG_GROUP_INVITE_RESPONSE, 0x3603 },
        { CMSG_GROUP_SET_ROLES, 0x35D9 },
        { CMSG_GUILD_ACHIEVEMENT_PROGRESS_QUERY, 0x3071 },
        { CMSG_GUILD_ASSIGN_MEMBER_RANK, 0x305F },
        { CMSG_GUILD_BANK_MONEY_WITHDRAWN_QUERY, 0x3083 },
        { CMSG_GUILD_BANK_QUERY_TEXT, 0x3087 },
        { CMSG_GUILD_CHANGE_NAME_REQUEST, 0x307E },
        { CMSG_GUILD_MEMBER_SEND_SOR_REQUEST, 0x308C },
        { CMSG_AUTO_DECLINE_GUILD_INVITES, 0x3522 },
        { CMSG_GUILD_NEWS_UPDATE_STICKY, 0x306E },
        { CMSG_GUILD_QUERY_NEWS, 0x306C },
        { CMSG_GUILD_QUERY_RANKS, 0x306D },
        { CMSG_REPLACE_GUILD_MASTER, 0x3088 },
        { CMSG_GUILD_REQUEST_CHALLENGE_UPDATE, 0x307B },
        { CMSG_GUILD_REQUEST_PARTY_STATE, 0x31A3 },
        { CMSG_GUILD_SET_ACHIEVEMENT_TRACKING, 0x306F },
        { CMSG_GUILD_SET_NOTE, 0x3072 },
        ...
        { CMSG_LF_GUILD_POST_REQUEST, 0x3076 },
        ...
        { CMSG_MAKE_EVERYONE_ASSISTANT, 0x3617 },
        { CMSG_MESSAGECHAT_ADDON_GUILD, 0x37D4 },
        { CMSG_MESSAGECHAT_ADDON_OFFICER, 0x37D6 },
        { CMSG_MESSAGECHAT_ADDON_PARTY, 0x37EF },
        { CMSG_MESSAGECHAT_ADDON_RAID, 0x37F1 },
        { CMSG_MESSAGECHAT_ADDON_WHISPER, 0x37D2 },
        { CMSG_MESSAGECHAT_AFK, 0x37D7 },
        { CMSG_MESSAGECHAT_CHANNEL, 0x37CF },
        { CMSG_MESSAGECHAT_DND, 0x37D8 },
        { CMSG_MESSAGECHAT_EMOTE, 0x37EC },
        { CMSG_MESSAGECHAT_GUILD, 0x37D3 },
        { CMSG_MESSAGECHAT_OFFICER, 0x37D5 },
        { CMSG_MESSAGECHAT_PARTY, 0x37EE },
        { CMSG_MESSAGECHAT_RAID, 0x37F0 },
        { CMSG_MESSAGECHAT_RAID_WARNING, 0x37F4 },
        { CMSG_MESSAGECHAT_SAY, 0x37EB },
        { CMSG_MESSAGECHAT_WHISPER, 0x37D1 },
        { CMSG_MESSAGECHAT_YELL, 0x37ED },
        { CMSG_OBJECT_UPDATE_FAILED, 0x317F },
        { CMSG_OBJECT_UPDATE_RESCUED, 0x3180 },
        { CMSG_QUERY_GUILD_MEMBERS_FOR_RECIPES, 0x306B },
        { CMSG_QUERY_GUILD_MEMBER_RECIPES, 0x3069 },
        { CMSG_QUERY_GUILD_RECIPES, 0x306A },
        { CMSG_QUERY_GUILD_REWARDS, 0x31A2 },
        { CMSG_RANDOMIZE_CHAR_NAME, 0x35E7 },
        { CMSG_REORDER_CHARACTERS, 0x35E9 },
        { CMSG_REPORT, 0x366C },
        { CMSG_REPORT_PLAYER, 0x3644 },
        { CMSG_REQUEST_CATEGORY_COOLDOWNS, 0x317C },
        { CMSG_REQUEST_CEMETERY_LIST, 0x3174 },
        { CMSG_REQUEST_HOTFIX, 0x35E4 },
        { CMSG_REQUEST_PVP_OPTIONS_ENABLED, 0x35EE },
        { CMSG_REQUEST_PVP_REWARDS, 0x3190 },
        { CMSG_REQUEST_RATED_BG_STATS, 0x35E3 },
        ...
        { SMSG_GUILD_NEWS_UPDATE, 0x29C1 },
        { SMSG_GUILD_PARTY_STATE_RESPONSE, 0x29CB },
        { SMSG_GUILD_RANK, 0x29C8 },
        { SMSG_GUILD_RANKS_UPDATE, 0x29B9 },
        { SMSG_GUILD_REPUTATION_REACTION_CHANGED, 0x29CC },
        { SMSG_GUILD_RESET, 0x29D8 },
        { SMSG_GUILD_REWARDS_LIST, 0x29C0 },
        { SMSG_GUILD_UPDATE_ROSTER, 0x29BC },
        { SMSG_SETUP_CURRENCY, 0x2572 },
        { SMSG_INSTANCE_LOOK_WARNING_QUERY, 0x2730 },
        { SMSG_ITEM_ADD_PASSIVE, 0x25BF },
        { SMSG_ITEM_REMOVE_PASSIVE, 0x25C0 },
        { SMSG_LF_GUILD_APPLICANT_LIST_UPDATED, 0x29CF },
        ...
        { SMSG_MONEY_NOTIFY, 0x25AE },
        { SMSG_MOVE_COLLISION_DISABLE, 0x2DDD },
        { SMSG_MOVE_COLLISION_ENABLE, 0x2DDE },
        ...
        { SMSG_SPELLINTERRUPTLOG, 0x2C20 },
        { SMSG_SPLINE_MOVE_COLLISION_DISABLE, 0x2DE9 },
        { SMSG_SPLINE_MOVE_COLLISION_ENABLE, 0x2DEA },
        { SMSG_SPLINE_MOVE_SET_ANIM, 0x2775 },
        { SMSG_SPLINE_MOVE_SET_FLYING, 0x2DF5 },
        { SMSG_START_TIMER, 0x25BB },
        { SMSG_STREAMING_MOVIE, 0x25BA },
        { SMSG_SUSPEND_TOKEN_RESPONSE, 0x25BD },
        { SMSG_TIME_ADJUSTMENT, 0x2DA1 },
        { SMSG_UI_TIME, 0x2753 },
        { SMSG_UPDATE_CURRENCY, 0x2573 },
        { SMSG_UPDATE_CURRENCY_WEEK_LIMIT, 0x25B7 },
        ...
        { SMSG_WARGAME_CHECK_ENTRY, 0x259E },
        { SMSG_WEEKLY_RESET_CURRENCY, 0x2574 },
        { SMSG_WEEKLY_SPELL_USAGE, 0x2C18 },
        { SMSG_WEEKLY_SPELL_USAGE_UPDATE, 0x2C19 },
        ...
        { CMSG_REALM_NAME_QUERY, 0x368C },
        { SMSG_GM_TICKET_CASE_STATUS, 0x26CC },
        { SMSG_MIRRORIMAGE_COMPONENTED_DATA, 0x2C14 },
        { SMSG_MIRRORIMAGE_CREATURE_DATA, 0x2C13 },
    ...
    const OpcodeSource legionOpcodes{ legionOpcodeEntries, std::size(legionOpcodeEntries) };
}
