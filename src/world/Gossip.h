...
enum MenuItemOptions
{
    ...
    GI_WYMREST_TOP_TO_BOTTOM,       // "Yes, please, I would like to return to the ground level of the temple."
    GI_WYMREST_TOP_TO_MIDDLE,       // "I would like to go Lord Afrasastrasz in the middle of the temple."
    GI_WYMREST_MIDDLE_TO_TOP,       // "My lord, I need to get to the top of the temple."
    GI_WYMREST_MIDDLE_TO_BOTTOM,    // "Can I get a ride back to ground level, Lord Afrasastrasz?"
    GI_WYMREST_BOTTOM_TO_TOP,       // "Steward, please allow me to ride one of the drakes to the queen's chamber at the top of the temple."
    GI_WYMREST_BOTTOM_TO_MIDDLE,    // "Can you spare a drake to take me to Lord Afrasastrasz in the middle of the temple?"
    GI_DISABLE_XP_GAIN,             // "I no longer wish to gain experience."
