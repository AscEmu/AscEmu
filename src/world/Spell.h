...
enum SPELL_MODIFIER_TYPE
{
    ...
    SMT_RESIST_DISPEL       = 28, ///\todo chance to resist dispell effects, NEEDS WORK :D
...
enum AttributesExC // 3
{
    ...
    FLAGS4_PLAYER_RANGED_WAND               = 0x00400000,
    FLAGS4_UNK25                            = 0x00800000,
    FLAGS4_TYPE_OFFHAND                     = 0x01000000,
...
enum AttributesExE // 5
{
    ...
    FLAGS6_USABLE_WHILE_STUNNED             = 0x00000008,
    FLAGS6_UNK6                             = 0x00000010,
    FLAGS6_SINGLE_TARGET_AURA               = 0x00000020,
    FLAGS6_UNK8                             = 0x00000040,
    FLAGS6_UNK9                             = 0x00000080,
    FLAGS6_UNK10                            = 0x00000100,
    FLAGS6_UNK11                            = 0x00000200,
    FLAGS6_UNK12                            = 0x00000400,
    FLAGS6_UNK13                            = 0x00000800,
    FLAGS6_UNK14                            = 0x00001000,
    FLAGS6_UNK15                            = 0x00002000,
    FLAGS6_UNK16                            = 0x00004000,
    FLAGS6_UNK17                            = 0x00008000,
    FLAGS6_UNK18                            = 0x00010000,
    FLAGS6_USABLE_WHILE_FEARED              = 0x00020000,
    FLAGS6_USABLE_WHILE_CONFUSED            = 0x00040000,
...
enum AttributesExF // 6
{
    ...
    FLAGS7_UNK2                             = 0x00000001,
    FLAGS7_UNUSED1                          = 0x00000002,   // only arena
    FLAGS7_UNK4                             = 0x00000004,
    FLAGS7_UNK5                             = 0x00000008,
    FLAGS7_UNUSED2                          = 0x00000010,   // unused 2.4.3 (2.4.3?!? o.O this means these FLAGS needs an update....)
    FLAGS7_UNK7                             = 0x00000020,
    FLAGS7_UNK8                             = 0x00000040,
    FLAGS7_UNK9                             = 0x00000080,
    FLAGS7_UNK10                            = 0x00000100,
    FLAGS7_UNUSED3                          = 0x00000200,   // unused 2.4.3
    FLAGS7_UNK12                            = 0x00000400,
    FLAGS7_UNK13                            = 0x00000800,
    FLAGS7_UNUSED4                          = 0x00001000,   // unused 2.4.3
    FLAGS7_UNK15                            = 0x00002000,
    FLAGS7_UNUSED5                          = 0x00004000,   // unused 2.4.3
    FLAGS7_UNUSED6                          = 0x00008000,   // unused 2.4.3
    FLAGS7_UNUSED7                          = 0x00010000,   // unused 2.4.3 - 20-33 also unused 2.4.3
...
enum SpellCastFlags
{
    ...
    CAST_FLAG_UNK9                  = 0x00000100,
    CAST_FLAG_UNK10                 = 0x00000100,
    CAST_FLAG_UNK11                 = 0x00000100,
    CAST_FLAG_UNK12                 = 0x00001000,
    CAST_FLAG_UNK13                 = 0x00001000,
    CAST_FLAG_UNK14                 = 0x00001000,
    CAST_FLAG_UNK15                 = 0x00001000,
    CAST_FLAG_UNK16                 = 0x00010000,
    CAST_FLAG_UNK17                 = 0x00010000,
    CAST_FLAG_UNK18                 = 0x00010000,
    CAST_FLAG_UNK19                 = 0x00010000,
    CAST_FLAG_UNK20                 = 0x00100000,
    CAST_FLAG_UNK21                 = 0x00100000,
    CAST_FLAG_UNK22                 = 0x00100000,
    CAST_FLAG_UNK23                 = 0x00100000,
    CAST_FLAG_UNK24                 = 0x01000000,
    CAST_FLAG_UNK25                 = 0x01000000,
    CAST_FLAG_UNK26                 = 0x01000000,
    CAST_FLAG_UNK27                 = 0x01000000,
    CAST_FLAG_UNK28                 = 0x10000000,
    CAST_FLAG_UNK29                 = 0x10000000,
    CAST_FLAG_UNK30                 = 0x10000000,
    CAST_FLAG_UNK31                 = 0x10000000,
};
