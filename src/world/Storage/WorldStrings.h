...
enum ServerString
{
    ...
    SS_MUST_BE_LEVEL_X = 31,                                                                    // "You must be at least level {} to pass through here."
    // 32                                                                                       // "You must be in a party to pass through here."
    // 33                                                                                       // "You must be level 70 to enter heroic mode."
    // 34                                                                                       // "-"
    SS_MUST_HAVE_ITEM = 35,                                                                     // "You must have the item, `{}` to pass through here."
    ...
    SS_BATTLE_BEGIN_ONE_MINUTE = 46,                                                            // "One minute until the battle for {} begins!"
    SS_THIRTY_SECONDS_UNTIL_THE_BATTLE = 47,                                                    // "Thirty seconds until the battle for {} begins!"
    SS_FIFTEEN_SECONDS_UNTIL_THE_BATTLE = 48,                                                   // "Fifteen seconds until the battle for {} begins!"
    SS_THE_BATTLE_FOR_HAS_BEGUN = 49,                                                           // "The battle for {} has begun!"
    ...
    SS_QUEUE_BG_INSTANCE_ID_NO_VALID_DELETED = 52,                                              // "Your queue on battleground instance id {} is no longer valid. Reason: Instance Deleted."
    SS_YOU_CANNOT_JOIN_BG_AS_IT_HAS_ALREADY_ENDED = 53,                                         // "You cannot join this battleground as it has already ended."
    SS_QUEUE_BG_INSTANCE_ID_NO_VALID_LONGER_EXISTS = 54,                                        // "Your queue on battleground instance {} is no longer valid, the instance no longer exists."
    ...
    SS_MUST_HAVE_QUEST = 81,                                                                    // "You must have the quest, '{}' completed to pass through here."
    ...
    SS_BANNED_FOR_TIME = 502,                                                                   // "You have been banned for: {}"
