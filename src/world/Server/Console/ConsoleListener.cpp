...
bool StartConsoleListener()
{
    ...
    return false;
#else
    std::string lhost = sWorld.settings.remoteConsole.host;
    uint32 lport = sWorld.settings.remoteConsole.port;
    bool enabled = sWorld.settings.remoteConsole.isEnabled;
