...
OpcodeTableEntry g_worldOpcodeNames[NUM_MSG_TYPES] = {
    ...
    { SMSG_MOVE_SET_FLIGHT_SPEED, "SMSG_MOVE_SET_FLIGHT_SPEED" },
    { SMSG_MOVE_SET_FLIGHT_BACK_SPEED, "SMSG_MOVE_SET_FLIGHT_BACK_SPEED" },
    { SMSG_MOVE_SET_PITCH_RATE, "SMSG_MOVE_SET_PITCH_RATE" },
    { SMSG_MOVE_SET_RUN_SPEED, "SMSG_MOVE_SET_RUN_SPEED" },
    { SMSG_MOVE_SET_RUN_BACK_SPEED, "SMSG_MOVE_SET_RUN_BACK_SPEED" },
    { SMSG_MOVE_SET_SWIM_SPEED, "SMSG_MOVE_SET_SWIM_SPEED" },
    { SMSG_MOVE_SET_SWIM_BACK_SPEED, "SMSG_MOVE_SET_SWIM_BACK_SPEED" },
    { SMSG_MOVE_SET_TURN_RATE, "SMSG_MOVE_SET_TURN_RATE" },
    { SMSG_MOVE_SET_WALK_SPEED, "SMSG_MOVE_SET_WALK_SPEED" },
    ...
    { SMSG_INSPECT_RESULT, "SMSG_INSPECT_RESULT" },
    ...
    { CMSG_RANDOM_CHAR_NAME, "CMSG_RANDOM_CHAR_NAME" },
    { SMSG_RANDOM_CHAR_NAME, "SMSG_RANDOM_CHAR_NAME" },

    { CMSG_SUBMIT_BUG, "CMSG_SUBMIT_BUG" },
    { CMSG_SUBMIT_SUGGESTION, "CMSG_SUBMIT_SUGGESTION" },
    { CMSG_GUILD_ACHIEVEMENT_PROGRESS_QUERY, "CMSG_GUILD_ACHIEVEMENT_PROGRESS_QUERY" }
};
