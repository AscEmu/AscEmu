...
{
    class SmsgAuctionBidderListResult : public ManagedPacket
    {
    public:
        ...
        SmsgAuctionBidderListResult() : SmsgAuctionBidderListResult(0, {}, 0, 0)
        {
        }

        SmsgAuctionBidderListResult(uint32_t listItemCount, std::vector<AuctionPacketList> auctionPacketList, uint32_t totalCount, uint32_t unknown = 0) :
            ManagedPacket(SMSG_AUCTION_BIDDER_LIST_RESULT, 24),
