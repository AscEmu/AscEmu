...
{
    class SmsgAuctionListResult : public ManagedPacket
    {
    public:
        ...
        SmsgAuctionListResult() : SmsgAuctionListResult(0, {}, 0, 0)
        {
        }

        SmsgAuctionListResult(uint32_t listItemCount, std::vector<AuctionPacketList> auctionPacketList, uint32_t totalCount, uint32_t unknown = 0) :
            ManagedPacket(SMSG_AUCTION_LIST_RESULT, 24),
