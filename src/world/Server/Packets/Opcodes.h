...
enum Opcodes
{
    ...
    SMSG_FORCE_WALK_SPEED_CHANGE                    = 0x2DA,    // implemented
    ...
    SMSG_FORCE_TURN_RATE_CHANGE                     = 0x2DE,    // implemented
    ...
    SMSG_SPLINE_SET_RUN_SPEED                       = 0x2FE,    // implemented
    SMSG_SPLINE_SET_RUN_BACK_SPEED                  = 0x2FF,    // implemented
    SMSG_SPLINE_SET_SWIM_SPEED                      = 0x300,    // implemented
    SMSG_SPLINE_SET_WALK_SPEED                      = 0x301,    // implemented
    SMSG_SPLINE_SET_SWIM_BACK_SPEED                 = 0x302,    // implemented
    SMSG_SPLINE_SET_TURN_RATE                       = 0x303,    // implemented
    ...
    MSG_MOVE_SET_FLIGHT_SPEED                       = 0x37E,    // implemented
    MSG_MOVE_SET_FLIGHT_BACK_SPEED_CHEAT            = 0x37F,    // GM client only
    MSG_MOVE_SET_FLIGHT_BACK_SPEED                  = 0x380,    // implemented
    SMSG_FORCE_FLIGHT_SPEED_CHANGE                  = 0x381,    // implemented
    CMSG_FORCE_FLIGHT_SPEED_CHANGE_ACK              = 0x382,    // implemented
    SMSG_FORCE_FLIGHT_BACK_SPEED_CHANGE             = 0x383,    // implemented
    CMSG_FORCE_FLIGHT_BACK_SPEED_CHANGE_ACK         = 0x384,    // implemented
    SMSG_SPLINE_SET_FLIGHT_SPEED                    = 0x385,    // implemented
    SMSG_SPLINE_SET_FLIGHT_BACK_SPEED               = 0x386,    // implemented
    ...
    MSG_MOVE_SET_PITCH_RATE                         = 0x45B,    // implemented
    SMSG_FORCE_PITCH_RATE_CHANGE                    = 0x45C,    // implemented
    CMSG_FORCE_PITCH_RATE_CHANGE_ACK                = 0x45D,    // not used in client
    SMSG_SPLINE_SET_PITCH_RATE                      = 0x45E,    // implemented
