...
enum Opcodes
{
    ...
    MSG_MOVE_SET_FLIGHT_BACK_SPEED                      = 0x30A2,   // not implemented
    ...
    SMSG_SPLINE_MOVE_WATER_WALK                         = 0x50A2,   // not implemented
    SMSG_SPLINE_MOVE_LAND_WALK                          = 0x3DA7,   // not implemented
