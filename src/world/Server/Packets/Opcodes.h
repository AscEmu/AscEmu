...
enum Opcodes
{
    ...
    SMSG_SPLINE_MOVE_UNROOT                         = 0x304,    // implemented
    SMSG_SPLINE_MOVE_FEATHER_FALL                   = 0x305,    // implemented
    SMSG_SPLINE_MOVE_NORMAL_FALL                    = 0x306,    // implemented
    SMSG_SPLINE_MOVE_SET_HOVER                      = 0x307,    // implemented
    SMSG_SPLINE_MOVE_UNSET_HOVER                    = 0x308,    // implemented
    SMSG_SPLINE_MOVE_WATER_WALK                     = 0x309,    // implemented
    SMSG_SPLINE_MOVE_LAND_WALK                      = 0x30A,    // implemented
    SMSG_SPLINE_MOVE_START_SWIM                     = 0x30B,    // implemented
    SMSG_SPLINE_MOVE_STOP_SWIM                      = 0x30C,    // implemented
    SMSG_SPLINE_MOVE_SET_RUN_MODE                   = 0x30D,    // implemented
    SMSG_SPLINE_MOVE_SET_WALK_MODE                  = 0x30E,    // implemented
    ...
    SMSG_SPLINE_MOVE_SET_FLYING                     = 0x422,    // implemented
    SMSG_SPLINE_MOVE_UNSET_FLYING                   = 0x423,    // implemented
    ...
    SMSG_SPLINE_MOVE_GRAVITY_DISABLE                = 0x4D3,    // implemented
    SMSG_SPLINE_MOVE_GRAVITY_ENABLE                 = 0x4D4,    // implemented
