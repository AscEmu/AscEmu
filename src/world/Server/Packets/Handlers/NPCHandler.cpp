...
void WorldSession::handleTabardVendorActivateOpcode(WorldPacket& recvPacket)
{
    ...
    logger.debug("Received MSG_TABARDVENDOR_ACTIVATE: %u (guidLowPart)", srlPacket.guid.getGuidLowPart());
...
void WorldSession::handleBankerActivateOpcode(WorldPacket& recvPacket)
{
    ...
    logger.debug("Received CMSG_BANKER_ACTIVATE: %u (guidLowPart)", srlPacket.guid.getGuidLowPart());
...
void WorldSession::handleAuctionHelloOpcode(WorldPacket& recvPacket)
{
    ...
    logger.debug("Received MSG_AUCTION_HELLO: %u (guidLowPart)", srlPacket.guid.getGuidLowPart());
...
void WorldSession::handleTrainerBuySpellOpcode(WorldPacket& recvPacket)
{
    ...
    logger.debug("Received CMSG_TRAINER_BUY_SPELL: %u (guidLowPart)", srlPacket.guid.getGuidLowPart());
...
void WorldSession::handleCharterShowListOpcode(WorldPacket& recvPacket)
{
    ...
    logger.debug("Received CMSG_CHARTER_SHOW_LIST: %u (guidLowPart)", srlPacket.guid.getGuidLowPart());
...
void WorldSession::handleGossipHelloOpcode(WorldPacket& recvPacket)
{
    ...
    logger.debug("Received CMSG_GOSSIP_HELLO: %u (guidLowPart)", srlPacket.guid.getGuidLowPart());
...
void WorldSession::handleGossipSelectOptionOpcode(WorldPacket& recvPacket)
{
    ...
    logger.debug("Received CMSG_GOSSIP_SELECT_OPTION: %u (gossipId), %i (option), %u (guidLow)",
...
void WorldSession::handleBinderActivateOpcode(WorldPacket& recvPacket)
{
    ...
    logger.debug("Received CMSG_BINDER_ACTIVATE: %u (guidLowPart)", srlPacket.guid.getGuidLowPart());
...
void WorldSession::sendTrainerList(Creature* creature)
{
    ...
    else
    {
        ...
        if (stricmp(trainer->UIMessage, "DMSG") == 0)
            data << _player->GetSession()->LocalizedWorldSrv(ServerString::SS_WHAT_CAN_I_TEACH_YOU);
        else
...
void WorldSession::handleNpcTextQueryOpcode(WorldPacket& recvPacket)
{
    ...
    logger.debug("Received: CMSG_NPC_TEXT_QUERY: %u (textId)", srlPacket.text_id);
...
void WorldSession::handleBuyBankSlotOpcode(WorldPacket& recvPacket)
{
    ...
    logger.debug("Received CMSG_BUY_BANK_SLOT: %u (guidLow)", srlPacket.guid.getGuidLow());
