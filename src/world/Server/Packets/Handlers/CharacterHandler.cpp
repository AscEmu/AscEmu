...
void WorldSession::CharacterEnumProc(QueryResult* result)
{
    ...
    if (result)
    {
        do
        {
            ...
            {
                LogDebugFlag(LF_OPCODE, "Your character table includes DeathKnights! You are running AscEmu for Classic clients - skip!", Util::getMSTime() - start_time);
                continue;
            }
    ...
    if (result)
    {
        do
        {
            ...
            switch (charEnum.race)
            {
                ...
                case 22:
                {
                    LogDebugFlag(LF_OPCODE, "Your character table includes an unsupported race %u! You are running AscEmu for TBC clients - skip!", charEnum.race);
    ...
    if (result)
    {
        do
        {
            ...
            switch (charEnum.race)
            {
                ...
                case 22:
                {
                    LogDebugFlag(LF_OPCODE, "Your character table includes an unsupported race %u! You are running AscEmu for WotLK clients - skip!", charEnum.race);
