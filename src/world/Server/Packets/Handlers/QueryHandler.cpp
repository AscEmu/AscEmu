...
void WorldSession::handleNameQueryOpcode(WorldPacket& recvData)
{
    ...
    LOGGER.debug("Received CMSG_NAME_QUERY for: %s", info->name);
...
void WorldSession::handleGameObjectQueryOpcode(WorldPacket& recvData)
{
    ...
    LOGGER.debug("Received CMSG_GAMEOBJECT_QUERY for entry: %u", srlPacket.entry);
...
void WorldSession::handleCreatureQueryOpcode(WorldPacket& recvData)
{
    ...
    LOGGER.debug("Received SMSG_CREATURE_QUERY_RESPONSE for entry: %u", srlPacket.entry);
...
void WorldSession::handlePageTextQueryOpcode(WorldPacket& recvPacket)
{
    ...
    LOGGER.debug("Received CMSG_PAGE_TEXT_QUERY: %u (pageId)", srlPacket.pageId);
...
void WorldSession::handleItemNameQueryOpcode(WorldPacket& recvPacket)
{
    ...
    LOGGER.debug("Received CMSG_ITEM_NAME_QUERY: %u (itemEntry)", srlPacket.itemEntry);
