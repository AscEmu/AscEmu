...
namespace Movement
{
    namespace Spline
    {
        enum SplineFlagsEnum
        {
            ...
            SPLINEFLAG_CYCLIC = 0x00001000, //note implemented
            SPLINEFLAG_ENTER_CYCLIC = 0x00002000,   //note implemented
            SPLINEFLAG_FROZEN = 0x00004000, //note implemented
            SPLINEFLAG_ENTER_VEHICLE = 0x00008000,  //note implemented
            SPLINEFLAG_EXIT_VEHICLE = 0x00010000,   //note implemented
            SPLINEFLAG_UNK3 = 0x00020000,
            SPLINEFLAG_UNK4 = 0x00040000,
            SPLINEFLAG_ORIENTATION_INVERSED = 0x00080000,   //note implemented
            SPLINEFLAG_SMOOTH_GROUND_PATH = 0x00100000, //note implemented
            SPLINEFLAG_WALKMODE = 0x00200000,
            SPLINEFLAG_UNCOMPRESSED_PATH = 0x00400000, //note implemented
