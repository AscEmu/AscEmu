...
void GameEventMgr::LoadFromDB()
{
    ...
    // Loading event_properties
    {
        ...
        do
        {
            ...
            //else
            //{
            //    LOGGER.debug("%s game event Entry: %u isn't a world event and has length = 0, thus it can't be used.", dbResult.description.c_str(), dbResult.entry);
            //}
