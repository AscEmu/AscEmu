...
uint32 AuctionHouse::GetID() { return dbc->id; }
...
{
    LOG_DEBUG("%u: Removing auction %u, reason %u.", dbc->id, auct->Id, auct->removedType);

    char subject[100];
    char body[200];
    switch (auct->removedType)
    {
