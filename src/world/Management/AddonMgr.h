...
struct AddonEntry
{
    AddonEntry(const std::string& nameAddon, uint8 enabledAddon, uint32 crcAddon, uint8 stateAddon, bool crcOrPubKeyAddon)
        : name(nameAddon), showinlist(enabledAddon), crc(crcAddon), status(stateAddon), isNew(crcOrPubKeyAddon)
    {}
