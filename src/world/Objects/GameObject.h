...
public:
    ...
    GameObjectProperties const* GetGameObjectProperties() const;
        ...
        bool CreateFromProto(uint32_t entry, uint32_t mapid, float x, float y, float z, float ang, float r0 = 0.0f, float r1 = 0.0f, float r2 = 0.0f, float r3 = 0.0f, uint32_t overrides = 0);
        ...
        int64_t GetRotation() const { return m_rotation; }
    ...
    protected:
        ...
        uint32_t _fields[GAMEOBJECT_END];

        uint32_t m_overrides; // See enum GAMEOBJECT_OVERRIDES!
