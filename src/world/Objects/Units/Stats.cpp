...
uint32_t CalculateDamage(Unit* pAttacker, Unit* pVictim, uint32_t weapon_damage_type, SpellInfo const* ability)   // spellid is used only for 2-3 spells, that have AP bonus
{
