...
namespace
{
    ...
    // SMSG_MOVE_TELEPORT: sent to the teleported player, answered with CMSG_MOVE_TELEPORT_ACK
    static constexpr std::array MopMSG_MOVE_TELEPORTDescriptor
    {
        MovementStep{ MovementOp::GuidBit0 },
        MovementStep{ MovementOp::GuidBit6 },
        MovementStep{ MovementOp::GuidBit5 },
    ...
    // SMSG_MOVE_UPDATE_TELEPORT: sent to the players around the teleported unit
    static constexpr std::array MopSMSG_MOVE_UPDATE_TELEPORTDescriptor
    {
        MovementStep{ MovementOp::PosZ },
        MovementStep{ MovementOp::PosY },
        MovementStep{ MovementOp::PosX },
...
std::span<MovementStep const> getClassicMovementDescriptor(uint16_t opcode, bool read)
{
    ...
    if (read)
        internalId = sOpcodeTables.getInternalIdForHex(opcode, WoW::versionIdFor(WoW::Expansion::_Classic));
    else
...
std::span<MovementStep const> getTbcMovementDescriptor(uint16_t opcode, bool read)
{
    uint32_t internalId = 0;
    if (read)
        internalId = sOpcodeTables.getInternalIdForHex(opcode, WoW::versionIdFor(WoW::Expansion::_TBC));
    else
        internalId = static_cast<uint32_t>(opcode);
...
std::span<MovementStep const> getWotlkMovementDescriptor(uint16_t opcode, bool read)
{
    uint32_t internalId = 0;
    if (read)
        internalId = sOpcodeTables.getInternalIdForHex(opcode, WoW::versionIdFor(WoW::Expansion::_WotLK));
    else
        internalId = static_cast<uint32_t>(opcode);
...
std::span<MovementStep const> getCataMovementDescriptor(uint16_t opcode, bool read)
{
    uint32_t internalId = 0;
    if (read)
        internalId = sOpcodeTables.getInternalIdForHex(opcode, WoW::versionIdFor(WoW::Expansion::_Cata));
    else
        internalId = static_cast<uint32_t>(opcode);
...
std::span<MovementStep const> getMopMovementDescriptor(uint16_t opcode, bool read)
{
    uint32_t internalId = 0;
    if (read)
        internalId = sOpcodeTables.getInternalIdForHex(opcode, WoW::versionIdFor(WoW::Expansion::_Mop));
    else
        internalId = static_cast<uint32_t>(opcode);
    ...
    switch (internalId)
    {
        ...
        case MSG_MOVE_TELEPORT:
            return MopMSG_MOVE_TELEPORTDescriptor;
        case SMSG_MOVE_UPDATE_TELEPORT:
            return MopSMSG_MOVE_UPDATE_TELEPORTDescriptor;
        default:
            return UnknownDescriptor;
    }
}
