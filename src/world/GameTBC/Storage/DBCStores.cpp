...
SERVER_DECL DBC::DBCStorage<DBC::Structures::ItemDisplayInfo> sItemDisplayInfoStore(DBC::Structures::item_display_info);
...
bool LoadDBCs()
{
    ...
    //DBC::LoadDBC(available_dbc_locales, bad_dbc_files, sLFGDungeonStore, dbc_path, "LFGDungeons.dbc"); -- disabled tbc
