...
// Generated for version 5.4.7 18019
...
enum EObjectFields
{
    ...
    OBJECT_FIELD_DYNAMIC_FLAGS                       = 0x0006, // Size: 1, Type: INT, Flags: PUBLIC
...
enum EUnitFields
{
    ...
    UNIT_FIELD_CRITTER                               = OBJECT_END + 0x0004, // Size: 2, Type: LONG, Flags: PUBLIC
    ...
    UNIT_FIELD_BATTLE_PET_COMPANION                  = OBJECT_END + 0x0010, // Size: 2, Type: LONG, Flags: PUBLIC
    ...
    UNIT_FIELD_SUMMONED_BY_HOME_REALM                = OBJECT_END + 0x0015, // Size: 1, Type: INT, Flags: PUBLIC
    ...
    UNIT_FIELD_OVERRIDE_DISPLAY_POWER_ID             = OBJECT_END + 0x0018, // Size: 1, Type: INT, Flags: PUBLIC
    ...
    UNIT_FIELD_POWER_REGEN_FLAT_MODIFIER             = OBJECT_END + 0x0025, // Size: 5, Type: FLOAT, Flags: PRIVATE, OWNER
    UNIT_FIELD_POWER_REGEN_INTERRUPTED_FLAT_MODIFIER = OBJECT_END + 0x002A, // Size: 5, Type: FLOAT, Flags: PRIVATE, OWNER
    ...
    UNIT_FIELD_MOD_HASTE                             = OBJECT_END + 0x004B, // Size: 1, Type: FLOAT, Flags: PUBLIC
    UNIT_FIELD_MOD_RANGED_HASTE                      = OBJECT_END + 0x004C, // Size: 1, Type: FLOAT, Flags: PUBLIC
    UNIT_FIELD_MOD_HASTE_REGEN                       = OBJECT_END + 0x004D, // Size: 1, Type: FLOAT, Flags: PUBLIC
    ...
    UNIT_DYNAMIC_FLAGS                               = OBJECT_END + 0x0050, // Size: 1, Type: INT, Flags: DYNAMIC
    ...
    UNIT_FIELD_RESISTANCES                           = OBJECT_END + 0x0061, // Size: 7, Type: INT, Flags: PRIVATE, OWNER, PARTY_LEADER
    ...
    UNIT_FIELD_ATTACK_POWER_MOD_POS                  = OBJECT_END + 0x007A, // Size: 1, Type: TWO_SHORT, Flags: PRIVATE, OWNER
    UNIT_FIELD_ATTACK_POWER_MOD_NEG                  = OBJECT_END + 0x007B, // Size: 1, Type: TWO_SHORT, Flags: PRIVATE, OWNER
    ...
    UNIT_FIELD_RANGED_ATTACK_POWER_MOD_POS           = OBJECT_END + 0x007E, // Size: 1, Type: TWO_SHORT, Flags: PRIVATE, OWNER
    UNIT_FIELD_RANGED_ATTACK_POWER_MOD_NEG           = OBJECT_END + 0x007F, // Size: 1, Type: TWO_SHORT, Flags: PRIVATE, OWNER
    ...
    UNIT_FIELD_MINITEMLEVEL                          = OBJECT_END + 0x0093, // Size: 1, Type: INT, Flags: PUBLIC
    UNIT_FIELD_MAXITEMLEVEL                          = OBJECT_END + 0x0094, // Size: 1, Type: INT, Flags: PUBLIC
    UNIT_FIELD_WILD_BATTLE_PET_LEVEL                 = OBJECT_END + 0x0095, // Size: 1, Type: INT, Flags: PUBLIC
    UNIT_FIELD_BATTLE_PET_COMPANION_NAME_TIMESTAMP   = OBJECT_END + 0x0096, // Size: 1, Type: INT, Flags: PUBLIC
    UNIT_FIELD_INTERACT_SPELL_ID                     = OBJECT_END + 0x0097, // Size: 1, Type: INT, Flags: PUBLIC
...
enum EItemFields
{
    ...
    ITEM_FIELD_MODIFIERS_MASK                        = OBJECT_END + 0x003C, // Size: 1, Type: INT, Flags: PUBLIC
...
enum EPlayerFields
{
    ...
    PLAYER_GUILDDELETE_DATE                          = UNIT_END + 0x0004, // Size: 1, Type: INT, Flags: PRIVATE
    ...
    PLAYER_FIELD_VIRTUAL_PLAYER_REALM                = UNIT_END + 0x0321, // Size: 1, Type: INT, Flags: NONE
    PLAYER_FIELD_CURRENT_SPEC_ID                     = UNIT_END + 0x0322, // Size: 1, Type: INT, Flags: PUBLIC
    PLAYER_FIELD_TAXI_MOUNT_ANIM_KIT_ID              = UNIT_END + 0x0323, // Size: 1, Type: INT, Flags: PUBLIC
    PLAYER_FIELD_CURRENT_BATTLE_PET_BREED_QUALITY    = UNIT_END + 0x0324, // Size: 1, Type: INT, Flags: PUBLIC
    ...
    PLAYER_FIELD_KNOWN_TITLES                        = UNIT_END + 0x03D3, // Size: 2, Type: LONG, Flags: PRIVATE
    PLAYER_FIELD_KNOWN_TITLES1                       = UNIT_END + 0x03D5, // Size: 2, Type: LONG, Flags: PRIVATE
    PLAYER_FIELD_KNOWN_TITLES2                       = UNIT_END + 0x03D7, // Size: 2, Type: LONG, Flags: PRIVATE
    PLAYER_FIELD_KNOWN_TITLES3                       = UNIT_END + 0x03D9, // Size: 2, Type: LONG, Flags: PRIVATE
    PLAYER_FIELD_KNOWN_TITLES4                       = UNIT_END + 0x03DB, // Size: 2, Type: LONG, Flags: PRIVATE
    PLAYER_FIELD_COINAGE                             = UNIT_END + 0x03DD, // Size: 2, Type: INT, Flags: PRIVATE
    ...
    PLAYER_KILL_STARTING_RANKS_0                     = UNIT_END + 0x04A1, // Size: 64, Type: TWO_SHORT, Flags: PRIVATE
    ...
    PLAYER_MAX_TALENT_TIERS                          = UNIT_END + 0x05A2, // Size: 1, Type: INT, Flags: PRIVATE
    ...
    PLAYER_COMBAT_RATING_EXPERTISE                   = UNIT_END + 0x05A8, // Size: 1, Type: INT, Flags: PRIVATE
    PLAYER_BLOCK_PERCENTAGE                          = UNIT_END + 0x05A9, // Size: 1, Type: INT, Flags: PRIVATE
    PLAYER_DODGE_PERCENTAGE                          = UNIT_END + 0x05AA, // Size: 1, Type: INT, Flags: PRIVATE
    PLAYER_PARRY_PERCENTAGE                          = UNIT_END + 0x05AB, // Size: 1, Type: INT, Flags: PRIVATE
    PLAYER_CRIT_PERCENTAGE                           = UNIT_END + 0x05AC, // Size: 1, Type: INT, Flags: PRIVATE
    PLAYER_RANGED_CRIT_PERCENTAGE                    = UNIT_END + 0x05AD, // Size: 1, Type: INT, Flags: PRIVATE
    PLAYER_OFFHAND_CRIT_PERCENTAGE                   = UNIT_END + 0x05AE, // Size: 1, Type: INT, Flags: PRIVATE
    PLAYER_SPELL_CRIT_PERCENTAGE1                    = UNIT_END + 0x05AF, // Size: 7, Type: INT, Flags: PRIVATE
    PLAYER_SHIELD_BLOCK                              = UNIT_END + 0x05B6, // Size: 1, Type: INT, Flags: PRIVATE
    PLAYER_SHIELD_BLOCK_CRIT_PERCENTAGE              = UNIT_END + 0x05B7, // Size: 1, Type: INT, Flags: PRIVATE
    PLAYER_MASTERY                                   = UNIT_END + 0x05B8, // Size: 1, Type: INT, Flags: PRIVATE
    PLAYER_PVP_POWER_DAMAGE                          = UNIT_END + 0x05B9, // Size: 1, Type: INT, Flags: PRIVATE
    PLAYER_PVP_POWER_HEALING                         = UNIT_END + 0x05BA, // Size: 1, Type: INT, Flags: PRIVATE
    ...
    PLAYER_FIELD_MOD_HEALING_PCT                     = UNIT_END + 0x069A, // Size: 1, Type: INT, Flags: PRIVATE
    PLAYER_FIELD_MOD_HEALING_DONE_PCT                = UNIT_END + 0x069B, // Size: 1, Type: INT, Flags: PRIVATE
    PLAYER_FIELD_MOD_PERIODIC_HEALING_DONE_PERCENT   = UNIT_END + 0x069C, // Size: 1, Type: INT, Flags: PRIVATE
    PLAYER_FIELD_WEAPON_DMG_MULTIPLIERS              = UNIT_END + 0x069D, // Size: 3, Type: INT, Flags: PRIVATE
    PLAYER_FIELD_MOD_SPELL_POWER_PCT                 = UNIT_END + 0x06A0, // Size: 1, Type: INT, Flags: PRIVATE
    PLAYER_FIELD_MOD_RESILIENCE_PERCENT              = UNIT_END + 0x06A1, // Size: 1, Type: INT, Flags: PRIVATE
    PLAYER_FIELD_OVERRIDE_SPELL_POWER_BY_AP_PCT      = UNIT_END + 0x06A2, // Size: 1, Type: INT, Flags: PRIVATE
    PLAYER_FIELD_OVERRIDE_APBY_SPELL_POWER_PERCENT   = UNIT_END + 0x06A3, // Size: 1, Type: INT, Flags: PRIVATE
    ...
    PLAYER_FIELD_BYTES                               = UNIT_END + 0x06A6, // Size: 1, Type: INT, Flags: PRIVATE
    ...
    PLAYER_FIELD_RESEARCHING_1                       = UNIT_END + 0x070E, // Size: 8, Type: INT, Flags: PRIVATE
    PLAYER_PROFESSION_SKILL_LINE_1                   = UNIT_END + 0x0716, // Size: 2, Type: INT, Flags: PRIVATE
    PLAYER_FIELD_UI_HIT_MODIFIER                     = UNIT_END + 0x0718, // Size: 1, Type: INT, Flags: PRIVATE
    PLAYER_FIELD_UI_SPELL_HIT_MODIFIER               = UNIT_END + 0x0719, // Size: 1, Type: INT, Flags: PRIVATE
    PLAYER_FIELD_HOME_REALM_TIME_OFFSET              = UNIT_END + 0x071A, // Size: 1, Type: INT, Flags: PRIVATE
    PLAYER_FIELD_MOD_PET_HASTE                       = UNIT_END + 0x071B, // Size: 1, Type: INT, Flags: PRIVATE
    PLAYER_FIELD_SUMMONED_BATTLE_PET_GUID            = UNIT_END + 0x071C, // Size: 2, Type: INT, Flags: PRIVATE
    PLAYER_FIELD_OVERRIDE_SPELLS_ID                  = UNIT_END + 0x071E, // Size: 1, Type: INT, Flags: PRIVATE
    PLAYER_FIELD_LFG_BONUS_FACTION_ID                = UNIT_END + 0x071F, // Size: 1, Type: INT, Flags: PRIVATE
    PLAYER_FIELD_LOOT_SPEC_ID                        = UNIT_END + 0x0720, // Size: 1, Type: INT, Flags: PRIVATE
    PLAYER_FIELD_OVERRIDE_ZONE_PVPTYPE               = UNIT_END + 0x0721, // Size: 1, Type: INT, Flags: PRIVATE
    PLAYER_FIELD_ITEM_LEVEL_DELTA                    = UNIT_END + 0x0722, // Size: 1, Type: INT, Flags: PRIVATE
...
enum EGameObjectFields
{
    ...
    GAMEOBJECT_DYNAMIC                               = OBJECT_END + 0x000A, // Size: 1, Type: BYTES, Flags: PUBLIC
...
{
    AREATRIGGER_CASTER_GUID                          = OBJECT_END + 0x000, // Size: 2, Type: LONG, Flags: PUBLIC
    AREATRIGGER_DURATION                             = OBJECT_END + 0x002, // Size: 1, Type: INT, Flags: PUBLIC
    AREATRIGGER_SPELLID                              = OBJECT_END + 0x003, // Size: 1, Type: INT, Flags: PUBLIC
    AREATRIGGER_SPELLVISUALID                        = OBJECT_END + 0x004, // Size: 1, Type: INT, Flags: PUBLIC
    AREATRIGGER_SCALE                                = OBJECT_END + 0x005, // Size: 1, Type: FLOAT, Flags: PUBLIC
