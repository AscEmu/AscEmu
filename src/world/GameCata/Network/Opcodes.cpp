...
OpcodeTable opcodeNameArray[NUM_MSG_TYPES] =
{
    ...
    { CMSG_MOVE_SET_CAN_FLY, "CMSG_MOVE_SET_CAN_FLY" },
    ...
    { SMSG_UNKNOWN_1208, "SMSG_UNKNOWN_1208" },
    ...
    { CMSG_UNKNOWN_1227, "CMSG_UNKNOWN_1227" },
    { SMSG_UNKNOWN_1228, "SMSG_UNKNOWN_1228" },
    ...
    { CMSG_FORCE_ANIM, "CMSG_FORCE_ANIM" },
    { SMSG_FORCE_ANIM, "SMSG_FORCE_ANIM" },
    { CMSG_CHAR_FACTION_CHANGE, "CMSG_CHAR_FACTION_CHANGE" },
    { SMSG_CHAR_FACTION_CHANGE, "SMSG_CHAR_FACTION_CHANGE" },
    { CMSG_PVP_QUEUE_STATS_REQUEST, "CMSG_PVP_QUEUE_STATS_REQUEST" },
    { SMSG_PVP_QUEUE_STATS, "SMSG_PVP_QUEUE_STATS" },
    { CMSG_SET_PAID_SERVICE_CHEAT, "CMSG_SET_PAID_SERVICE_CHEAT" },
    ...
    { CMSG_BATTLEFIELD_MANAGER_ADVANCE_STATE, "CMSG_BATTLEFIELD_MANAGER_ADVANCE_STATE" },
    { CMSG_BATTLEFIELD_MANAGER_SET_NEXT_TRANS_TIME, "CMSG_BATTLEFIELD_MANAGER_SET_NEXT_TRANS_TIME" },
    { MSG_SET_RAID_DIFFICULTY, "MSG_SET_RAID_DIFFICULTY" },
    { CMSG_TOGGLE_XP_GAIN, "CMSG_TOGGLE_XP_GAIN" },
    ...
    { SMSG_GMRESPONSE_CREATE_TICKET, "SMSG_GMRESPONSE_CREATE_TICKET" },
    { CMSG_GMRESPONSE_CREATE_TICKET, "CMSG_GMRESPONSE_CREATE_TICKET" },
    { CMSG_SERVERINFO, "CMSG_SERVERINFO" },
    { SMSG_SERVERINFO, "SMSG_SERVERINFO" },
    ...
    { CMSG_UI_TIME_REQUEST, "CMSG_UI_TIME_REQUEST" },
    { SMSG_UI_TIME, "SMSG_UI_TIME" },
    ...
    { CMSG_QUERY_BATTLEFIELD_STATE, "CMSG_QUERY_BATTLEFIELD_STATE" },
    { CMSG_GUILD_BANK_MONEY_WITHDRAWN, "CMSG_GUILD_BANK_MONEY_WITHDRAWN" },
    { SMSG_GUILD_BANK_MONEY_WITHDRAWN, "SMSG_GUILD_BANK_MONEY_WITHDRAWN" },
    { CMSG_UNREGISTER_ALL_ADDON_PREFIXES, "CMSG_UNREGISTER_ALL_ADDON_PREFIXES" },
    { CMSG_REQUEST_CATEGORY_COOLDOWNS, "CMSG_REQUEST_CATEGORY_COOLDOWNS" },
    { CMSG_REQUEST_HOTFIX, "CMSG_REQUEST_HOTFIX" },
    { CMSG_REQUEST_CEMETERY_LIST, "CMSG_REQUEST_CEMETERY_LIST" },
    { SMSG_REQUEST_CEMETERY_LIST_RESPONSE, "SMSG_REQUEST_CEMETERY_LIST_RESPONSE" },
    { CMSG_REORDER_CHARACTERS, "CMSG_REORDER_CHARACTERS" },
    { SMSG_MOVE_UPDATE_KNOCK_BACK, "SMSG_MOVE_UPDATE_KNOCK_BACK" },
    { SMSG_PLAYER_MOVE, "SMSG_PLAYER_MOVE" },
    { SMSG_SPELLOGDAMAGE_IMMUNE, "SMSG_SPELLOGDAMAGE_IMMUNE" },
    { SMSG_LOOT_UPDATE, "SMSG_LOOT_UPDATE" },
    { CMSG_OBJECT_UPDATE_FAILED, "CMSG_OBJECT_UPDATE_FAILED" },
    { CMSG_GROUP_INVITE_RESPONSE, "CMSG_GROUP_INVITE_RESPONSE" },
    { CMSG_GROUP_SET_ROLES, "CMSG_GROUP_SET_ROLES" },
    { SMSG_GROUP_SET_ROLE, "SMSG_GROUP_SET_ROLE" },
    { CMSG_GROUP_REQUEST_JOIN_UPDATES, "CMSG_GROUP_REQUEST_JOIN_UPDATES" },
    { CMSG_LEARN_PREVIEW_TALENTS, "CMSG_LEARN_PREVIEW_TALENTS" },
    { SMSG_MOVE_UPDATE_TELEPORT, "SMSG_MOVE_UPDATE_TELEPORT" },
    { CMSG_LFG_LOCK_INFO_REQUEST, "CMSG_LFG_LOCK_INFO_REQUEST" },
    { CMSG_ADDON_REGISTERED_PREFIXES, "CMSG_ADDON_REGISTERED_PREFIXES" },
    { CMSG_ROLE_CHECK_BEGIN, "CMSG_ROLE_CHECK_BEGIN" },
    { SMSG_ROLE_CHECK_BEGIN, "SMSG_ROLE_CHECK_BEGIN" },
    { CMSG_MAKE_EVERYONE_ASSISTANT, "CMSG_MAKE_EVERYONE_ASSISTANT" },
    { CMSG_REPORT_PLAYER, "CMSG_REPORT_PLAYER" },
    { CMSG_REPORT, "CMSG_REPORT" },
    { SMSG_REPORT_RESULT, "SMSG_REPORT_RESULT" },
    { CMSG_REQUEST_RATED_BG_INFO, "CMSG_REQUEST_RATED_BG_INFO" },
    { SMSG_RATED_BG_INFO, "SMSG_RATED_BG_INFO" },
    { CMSG_REQUEST_RATED_BG_STATS, "CMSG_REQUEST_RATED_BG_STATS" },
    { SMSG_RATED_BG_STATS, "SMSG_RATED_BG_STATS" },
    { CMSG_REQUEST_PVP_REWARDS, "CMSG_REQUEST_PVP_REWARDS" },
    { SMSG_REQUEST_PVP_REWARDS_RESPONSE, "SMSG_REQUEST_PVP_REWARDS_RESPONSE" },
    { CMSG_REQUEST_PVP_OPTIONS_ENABLED, "CMSG_REQUEST_PVP_OPTIONS_ENABLED" },
    { SMSG_PVP_OPTIONS_ENABLED, "SMSG_PVP_OPTIONS_ENABLED" },
    { SMSG_GUILD_MAX_DAILY_XP, "SMSG_GUILD_MAX_DAILY_XP" },
    { SMSG_GUILD_XP, "SMSG_GUILD_XP" },
    { SMSG_GUILD_XP_GAIN, "SMSG_GUILD_XP_GAIN" },
    { SMSG_GUILD_NEWS_UPDATE, "SMSG_GUILD_NEWS_UPDATE" },
    { SMSG_GUILD_NEWS_DELETED, "SMSG_GUILD_NEWS_DELETED" },
    { CMSG_GUILD_NEWS_UPDATE_STICKY, "CMSG_GUILD_NEWS_UPDATE_STICKY" },
    { SMSG_GUILD_QUERY_RANKS_RESULT, "SMSG_GUILD_QUERY_RANKS_RESULT" },
    { CMSG_GUILD_PERMISSIONS, "CMSG_GUILD_PERMISSIONS" },
    { CMSG_GUILD_REQUEST_PARTY_STATE, "CMSG_GUILD_REQUEST_PARTY_STATE" },
    { CMSG_GUILD_REQUEST_CHALLENGE_UPDATE, "CMSG_GUILD_REQUEST_CHALLENGE_UPDATE" },
    { CMSG_GUILD_QUERY_RANKS, "CMSG_GUILD_QUERY_RANKS" },
    { SMSG_GUILD_PARTY_STATE_RESPONSE, "SMSG_GUILD_PARTY_STATE_RESPONSE" },
    { SMSG_GUILD_EVENT_LOG_QUERY_RESULT, "SMSG_GUILD_EVENT_LOG_QUERY_RESULT" },
    { SMSG_GUILD_BANK_LOG_QUERY_RESULT, "SMSG_GUILD_BANK_LOG_QUERY_RESULT" },
    { SMSG_GUILD_PERMISSIONS_QUERY_RESULTS, "SMSG_GUILD_PERMISSIONS_QUERY_RESULTS" },
    { SMSG_GUILD_MEMBER_DAILY_RESET, "SMSG_GUILD_MEMBER_DAILY_RESET" },
    { SMSG_GUILD_RANKS_UPDATE, "SMSG_GUILD_RANKS_UPDATE" },
    { SMSG_GUILD_REPUTATION_WEEKLY_CAP, "SMSG_GUILD_REPUTATION_WEEKLY_CAP" },
    { SMSG_GUILD_BANK_QUERY_TEXT_RESULT, "SMSG_GUILD_BANK_QUERY_TEXT_RESULT" },
    { SMSG_GUILD_RANK, "SMSG_GUILD_RANK" },
    { SMSG_GUILD_REWARDS_LIST, "SMSG_GUILD_REWARDS_LIST" },
    { CMSG_GUILD_BANK_MONEY_WITHDRAWN_QUERY, "CMSG_GUILD_BANK_MONEY_WITHDRAWN_QUERY" },
    { CMSG_GUILD_BANK_QUERY_TEXT, "CMSG_GUILD_BANK_QUERY_TEXT" },
    { CMSG_QUERY_GUILD_XP, "CMSG_QUERY_GUILD_XP" },
    { CMSG_GUILD_SET_RANK_PERMISSIONS, "CMSG_GUILD_SET_RANK_PERMISSIONS" },
    { CMSG_GUILD_SET_NOTE, "CMSG_GUILD_SET_NOTE" },
    { CMSG_QUERY_GUILD_REWARDS, "CMSG_QUERY_GUILD_REWARDS" },
    { CMSG_GUILD_SWITCH_RANK, "CMSG_GUILD_SWITCH_RANK" },
    { CMSG_GUILD_ASSIGN_MEMBER_RANK, "CMSG_GUILD_ASSIGN_MEMBER_RANK" },
    { CMSG_QUERY_GUILD_RECIPES, "CMSG_QUERY_GUILD_RECIPES" },
    { CMSG_GUILD_EVENT_LOG_QUERY, "CMSG_GUILD_EVENT_LOG_QUERY" },
    { SMSG_LF_GUILD_APPLICANT_LIST_UPDATED, "SMSG_LF_GUILD_APPLICANT_LIST_UPDATED" },
    { SMSG_LF_GUILD_APPLICATIONS_LIST_CHANGED, "SMSG_LF_GUILD_APPLICATIONS_LIST_CHANGED" },
    { CMSG_LF_GUILD_ADD_RECRUIT, "CMSG_LF_GUILD_ADD_RECRUIT" },
    { CMSG_LF_GUILD_BROWSE, "CMSG_LF_GUILD_BROWSE" },
    { CMSG_LF_GUILD_DECLINE_RECRUIT, "CMSG_LF_GUILD_DECLINE_RECRUIT" },
    { CMSG_LF_GUILD_GET_APPLICATIONS, "CMSG_LF_GUILD_GET_APPLICATIONS" },
    { CMSG_LF_GUILD_GET_RECRUITS, "CMSG_LF_GUILD_GET_RECRUITS" },
    { CMSG_LF_GUILD_POST_REQUEST, "CMSG_LF_GUILD_POST_REQUEST" },
    { CMSG_LF_GUILD_REMOVE_RECRUIT, "CMSG_LF_GUILD_REMOVE_RECRUIT" },
    { CMSG_LF_GUILD_SET_GUILD_POST, "CMSG_LF_GUILD_SET_GUILD_POST" },
    { SMSG_LF_GUILD_BROWSE_UPDATED, "SMSG_LF_GUILD_BROWSE_UPDATED" },
    { SMSG_LF_GUILD_MEMBERSHIP_LIST_UPDATED, "SMSG_LF_GUILD_MEMBERSHIP_LIST_UPDATED" },
    { SMSG_LF_GUILD_RECRUIT_LIST_UPDATED, "SMSG_LF_GUILD_RECRUIT_LIST_UPDATED" },
    { SMSG_LF_GUILD_POST_UPDATED, "SMSG_LF_GUILD_POST_UPDATED" },
    { SMSG_GUILD_CHALLENGE_UPDATED, "SMSG_GUILD_CHALLENGE_UPDATED" },
    { CMSG_GUILD_REQUEST_MAX_DAILY_XP, "CMSG_GUILD_REQUEST_MAX_DAILY_XP" },
    { CMSG_GUILD_QUERY_NEWS, "CMSG_GUILD_QUERY_NEWS" },
    { CMSG_RETURN_TO_GRAVEYARD, "CMSG_RETURN_TO_GRAVEYARD" },
    { CMSG_UNKNOWN_ON_LOGIN, "CMSG_UNKNOWN_ON_LOGIN" },
    { CMSG_SUGGESTION, "CMSG_SUGGESTION" },
    { CMSG_INSPECT_HONOR_STATS, "CMSG_INSPECT_HONOR_STATS" },
    { SMSG_INSPECT_HONOR_STATS, "SMSG_INSPECT_HONOR_STATS" },
    { CMSG_REQUEST_INSPECT_RATED_BG_STATS, "CMSG_REQUEST_INSPECT_RATED_BG_STATS" },
    { CMSG_UNKNOWN_ON_LOGIN2, "CMSG_UNKNOWN_ON_LOGIN2" },
    { CMSG_UNKNOWN_ON_LOGIN3, "CMSG_UNKNOWN_ON_LOGIN3" },
    { CMSG_UNKNOWN_ON_LOGIN4, "CMSG_UNKNOWN_ON_LOGIN4" }
};
