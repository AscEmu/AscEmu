...
enum Opcodes
{
    ...
    SMSG_FORCE_RUN_SPEED_CHANGE = 0x10E3,       // new
    CMSG_FORCE_RUN_SPEED_CHANGE_ACK = 0x10E4,   // new
    SMSG_FORCE_RUN_BACK_SPEED_CHANGE = 0x10E5,  // new
    CMSG_FORCE_RUN_BACK_SPEED_CHANGE_ACK = 0x10E6,  // new
    SMSG_FORCE_SWIM_SPEED_CHANGE = 0x10E7,      // new
    ...
    SMSG_FORCE_WALK_SPEED_CHANGE = 0x12DB,          // new
    CMSG_FORCE_WALK_SPEED_CHANGE_ACK = 0x12DC,      // new
    SMSG_FORCE_SWIM_BACK_SPEED_CHANGE = 0x12DD,     // new
    CMSG_FORCE_SWIM_BACK_SPEED_CHANGE_ACK = 0x12DE, // new
    SMSG_FORCE_TURN_RATE_CHANGE = 0x12DF,           // new
