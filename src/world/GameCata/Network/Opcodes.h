...
enum Opcodes
{
    ...
    CMSG_GUILD_INVITE = 0x24B0,                     // new
    SMSG_GUILD_INVITE = 0x14A2,                     // new
    CMSG_GUILD_ACCEPT = 0x2531,                     // new
    CMSG_GUILD_DECLINE = 0x3231,                    // new
    SMSG_GUILD_DECLINE = 0x2C07,                    // new
    CMSG_GUILD_INFO = 0x0000,
    SMSG_GUILD_INFO = 0x0000,
    CMSG_GUILD_ROSTER = 0x1226,                     // new
    SMSG_GUILD_ROSTER = 0x3DA3,                     // new
    CMSG_GUILD_PROMOTE = 0x1030,                    // new
    CMSG_GUILD_DEMOTE = 0x1020,                     // new
    CMSG_GUILD_LEAVE = 0x1021,                      // new
    CMSG_GUILD_REMOVE = 0x1231,                     // new
    CMSG_GUILD_DISBAND = 0x3226,                    // new
    ...
    MSG_SAVE_GUILD_EMBLEM = 0x2404,                 // new
    ...
    CMSG_GUILD_RANK = 0x1024,                       // new
    CMSG_GUILD_ADD_RANK = 0x3030,                   // new
    CMSG_GUILD_DEL_RANK = 0x3234,                   // new
    ...
    CMSG_GUILD_INFO_TEXT = 0x3227,                      // new
    ...
    CMSG_GUILD_BANK_QUERY_TAB = 0x2E35,         // new
    SMSG_GUILD_BANK_LIST = 0x78A5,              // new
    CMSG_GUILD_BANK_SWAP_ITEMS = 0x2315,        // new
    CMSG_GUILD_BANK_BUY_TAB = 0x0C37,           // new
    CMSG_GUILD_BANK_UPDATE_TAB = 0x0106,        // new
    CMSG_GUILD_BANK_DEPOSIT_MONEY = 0x0707,     // new
    CMSG_GUILD_BANK_WITHDRAW_MONEY = 0x0037,    // new
    MSG_GUILD_BANK_LOG_QUERY = 0x3224,          // new
    ...
    CMSG_SET_GUILD_BANK_TEXT = 0x3023,                      // new
    ...
    SMSG_CRITERIA_UPDATE = 0x6E37,                      // new
    ...
    SMSG_CRITERIA_DELETED = 0x2915,                     // new
    ...
    CMSG_UPDATE_PROJECTILE_POSITION = 0x0E24,       // new
    ...
    CMSG_GUILD_BANK_MONEY_WITHDRAWN = 0x0000,           // new
    ...
    SMSG_GUILD_NEWS_UPDATE = 0x35A7,                    // new
    SMSG_GUILD_NEWS_DELETED = 0x74A7,                   // new
    CMSG_GUILD_NEWS_UPDATE_STICKY = 0x3223,             // new
    SMSG_GUILD_QUERY_RANKS_RESULT = 0x30B4,             // new
    CMSG_GUILD_PERMISSIONS = 0x3022,                    // new
    CMSG_GUILD_REQUEST_PARTY_STATE = 0x3900,            // new
    CMSG_GUILD_REQUEST_CHALLENGE_UPDATE = 0x1224,       // new
    CMSG_GUILD_QUERY_RANKS = 0x1026,                    // new
    SMSG_GUILD_PARTY_STATE_RESPONSE = 0x50A6,           // new
    SMSG_GUILD_EVENT_LOG_QUERY_RESULT = 0x10B2,         // new
    SMSG_GUILD_BANK_LOG_QUERY_RESULT = 0x30B2,          // new
    SMSG_GUILD_PERMISSIONS_QUERY_RESULTS = 0x34A3,      // new
    SMSG_GUILD_MEMBER_DAILY_RESET = 0x10A5,             // new
    SMSG_GUILD_RANKS_UPDATE = 0x5DA0,                   // new
    SMSG_GUILD_REPUTATION_WEEKLY_CAP = 0x30B7,          // new
    SMSG_GUILD_BANK_QUERY_TEXT_RESULT = 0x75A3,         // new
    SMSG_GUILD_RANK = 0x30B4,                           // new
    SMSG_GUILD_REWARDS_LIST = 0x1DB0,                   // new
    CMSG_GUILD_BANK_MONEY_WITHDRAWN_QUERY = 0x1225,     // new
    CMSG_GUILD_BANK_QUERY_TEXT = 0x3220,                // new
    CMSG_QUERY_GUILD_XP = 0x1237,                       // new
    CMSG_GUILD_SET_RANK_PERMISSIONS = 0x1024,           // new
    CMSG_GUILD_SET_NOTE = 0x1233,                       // new
    CMSG_QUERY_GUILD_REWARDS = 0x3012,                  // new
    CMSG_GUILD_SWITCH_RANK = 0x1221,                    // new
    CMSG_GUILD_ASSIGN_MEMBER_RANK = 0x3032,             // new
    CMSG_QUERY_GUILD_RECIPES = 0x3033,                  // new
    CMSG_GUILD_EVENT_LOG_QUERY = 0x1220,                // new
    SMSG_LF_GUILD_APPLICANT_LIST_UPDATED = 0x10A4,      // new
    SMSG_LF_GUILD_APPLICATIONS_LIST_CHANGED = 0x71A5,   // new
    CMSG_LF_GUILD_ADD_RECRUIT = 0x4448,                 // new
    CMSG_LF_GUILD_BROWSE = 0x0548,                      // new
    CMSG_LF_GUILD_DECLINE_RECRUIT = 0x1031,             // new
    CMSG_LF_GUILD_GET_APPLICATIONS = 0x1230,            // new
    CMSG_LF_GUILD_GET_RECRUITS = 0x3230,                // new
    CMSG_LF_GUILD_POST_REQUEST = 0x3237,                // new
    CMSG_LF_GUILD_REMOVE_RECRUIT = 0x3027,              // new
    CMSG_LF_GUILD_SET_GUILD_POST = 0x0448,              // new
    SMSG_LF_GUILD_BROWSE_UPDATED = 0x1DA3,              // new
    SMSG_LF_GUILD_MEMBERSHIP_LIST_UPDATED = 0x1CA5,     // new
    SMSG_LF_GUILD_RECRUIT_LIST_UPDATED = 0x1CB2,        // new
    SMSG_LF_GUILD_POST_UPDATED = 0x35B7,                // new
