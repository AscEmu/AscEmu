...
bool ChatHandler::HandleCharSetSpeedCommand(const char* args, WorldSession* m_session)
{
    ...
    player_target->SetSpeeds(TYPE_RUN, speed);
    player_target->SetSpeeds(TYPE_SWIM, speed);
    player_target->SetSpeeds(TYPE_RUN_BACK, speed / 2);
    player_target->SetSpeeds(TYPE_FLY, speed * 2);
