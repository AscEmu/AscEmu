...
class MapFile::MapFileImpl
{
    public:
        ...
        ErrorType error() const
        {
            ...
            switch(m_file.error())
            {
                case TextFile::ERROR_OPEN:
                    return MapFile::ERROR_OPEN;
                case TextFile::ERROR_READ:
                    return MapFile::ERROR_READ;
                case TextFile::ERROR_PARSE:
                    return MapFile::ERROR_PARSE;
                default:
                    return MapFile::ERROR_NONE;
            }
        }
