...
bool MySQLDatabase::Initialize(const char* Hostname, unsigned int port, const char* Username, const char* Password, const char* DatabaseName, uint32_t ConnectionCount, uint32_t /*BufferSize*/)
{
    uint32_t i;
    MYSQL* temp = NULL;
    MYSQL* temp2 = NULL;
